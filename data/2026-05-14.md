...
### [64] [Domain Adaptation of Large Language Models for Polymer-Composite Additive Manufacturing Using Retrieval-Augmented Generation and Fine-Tuning](https://arxiv.org/abs/2605.12516)
*Saiful Islam Sagor,Tania Haghighi,Minhaj Nur Alam,Erina Baynojir Joyee*
...
### [65] [RTLC -- Research, Teach-to-Learn, Critique: A three-stage prompting paradigm inspired by the Feynman Learning Technique that lifts LLM-as-judge accuracy on JudgeBench with no fine-tuning](https://arxiv.org/abs/2605.13695)
*Andrea Morandi*
...
### [66] [Bridging the Missing-Modality Gap: Improving Text-Only Calibration of Vision Language Models](https://arxiv.org/abs/2605.12517)
*Mingyeong Kim,Jungwon Choi,Chaeyun Jang,Juho Lee*
...
### [67] [Children's English Reading Story Generation via Supervised Fine-Tuning of Compact LLMs with Controllable Difficulty and Safety](https://arxiv.org/abs/2605.13709)
...
### [68] [TimelineReasoner: Advancing Timeline Summarization with Large Reasoning Models](https://arxiv.org/abs/2605.12518)
*Liancheng Zhang,Xiaoxi Li,Zhicheng Dou*
...
### [69] [Dense vs Sparse Pretraining at Tiny Scale: Active-Parameter vs Total-Parameter Matching](https://arxiv.org/abs/2605.13769)
*Abdalrahman Wael*
...
### [70] [Correct Answers from Sound Reasoning: Verifiable Process Supervision for Language Models](https://arxiv.org/abs/2605.12519)
*Kyuyoung Kim,Kevin Wang,Yunfei Xie,Peiyang Xu,Peiyao Sheng,Chen Wei,Zhangyang Wang,Jinwoo Shin,Pramod Viswanath,Sewoong Oh*
...
### [71] [Where Does Reasoning Break? Step-Level Hallucination Detection via Hidden-State Transport Geometry](https://arxiv.org/abs/2605.13772)
...
### [72] [BoostTaxo: Zero-Shot Taxonomy Induction via Boosting-Style Agentic Reasoning and Constraint-Aware Calibration](https://arxiv.org/abs/2605.12520)
*Yancheng Ling,Zhenlin Qin,Leizhen Wang,Zhenliang Ma*
...
### [73] [An LLM-Based System for Argument Reconstruction](https://arxiv.org/abs/2605.13793)
...
### [74] [ToolWeave: Structured Synthesis of Complex Multi-Turn Tool-Calling Dialogues](https://arxiv.org/abs/2605.12521)
*Dinesh Khandelwal,Gnana Prakash Punnavajhala,GPS Bhargav,Gaurav Pandey,Sachin Joshi,Hima Karanam,Dinesh Raghu*
...
### [75] [Negation Neglect: When models fail to learn negations in training](https://arxiv.org/abs/2605.13829)
...
### [76] [Differences in Text Generated by Diffusion and Autoregressive Language Models](https://arxiv.org/abs/2605.12522)
*Zeyang Zhang,Chengwei Liang,Xingyan Chen,Meiqi Gu,Minrui Luo,Jingzhao Zhang,Tianxing He*
...
### [77] [Good Agentic Friends Do Not Just Give Verbal Advice: They Can Update Your Weights](https://arxiv.org/abs/2605.13839)
...
### [78] [Exploring how EFL students talk to and through AI to develop texts](https://arxiv.org/abs/2605.12523)
*David James Woo,Yangyang Yu,Yilin Huang,Deliang Wang,Kai Guo,Chi Ho Yeung*
...
### [79] [WARDEN: Endangered Indigenous Language Transcription and Translation with 6 Hours of Training Data](https://arxiv.org/abs/2605.13846)
...
### [80] [In-Situ Behavioral Evaluation for LLM Fairness, Not Standardized-Test Scores](https://arxiv.org/abs/2605.12530)
*Zeyu Tang,Sang T. Truong,Deonna Owens,Shreyas Sharma,Yibo Jacky Zhang,Brando Miranda,Sanmi Koyejo*
...
### [81] [Training LLMs with Reinforcement Learning for Intent-Aware Personalized Question Answering](https://arxiv.org/abs/2605.12645)
*Maryam Amirizaniani,Benjamin Charles Germain Lee,Jevin West,Nicholas Weber*
...
### [82] [Simulating Students or Sycophantic Problem Solving? On Misconception Faithfulness of LLM Simulators](https://arxiv.org/abs/2605.12748)
*Heejin Do,Shashank Sonkar,Mrinmaya Sachan*
...
### [83] [REALISTA: Realistic Latent Adversarial Attacks that Elicit LLM Hallucinations](https://arxiv.org/abs/2605.12813)
*Buyun Liang,Jinqi Luo,Liangzu Peng,Kwan Ho Ryan Chan,Darshan Thaker,Kaleab A. Kinfu,Fengrui Tian,Hamed Hassani,René Vidal*
...
### [84] [Persona-Model Collapse in Emergent Misalignment](https://arxiv.org/abs/2605.12850)
*Davi Bastos Costa,Renato Vicente*
...
### [85] [Context Training with Active Information Seeking](https://arxiv.org/abs/2605.13050)
*Zeyu Huang,Adhiguna Kuncoro,Qixuan Feng,Jiajun Shen,Lucio Dery,Arthur Szlam,Marc'Aurelio Ranzato*
...
### [86] [Scaling few-shot spoken word classification with generative meta-continual learning](https://arxiv.org/abs/2605.13075)
*Louise Beyers,Batsirayi Mupamhi Ziki,Ruan van der Merwe*
...
### [87] [Does language matter for spoken word classification? A multilingual generative meta-learning approach](https://arxiv.org/abs/2605.13084)
*Batsirayi Mupamhi Ziki,Louise Beyers,Ruan van der Merwe*
...
### [88] [Vividh-ASR: A Complexity-Tiered Benchmark and Optimization Dynamics for Robust Indic Speech Recognition](https://arxiv.org/abs/2605.13087)
*Kush Juvekar,Kavya Manohar,Aditya Srinivas Menon,Arghya Bhattacharya,Kumarmanas Nethil*
...
### [89] [AcquisitionSynthesis: Targeted Data Generation using Acquisition Functions](https://arxiv.org/abs/2605.13149)
*Ishika Agarwal,Sofia Stoica,Emre Can Acikgoz,Pradeep Natarajan,Mahdi Namazifar,Jiaqi Ma,Dilek Hakkani-Tür*
...
### [90] [Utility-Oriented Visual Evidence Selection for Multimodal Retrieval-Augmented Generation](https://arxiv.org/abs/2605.13277)
*Weiqing Luo,Zongye Hu,Xiao Wang,Zhiyuan Yu,Haofeng Zhang,Ziyi Huang*
...
### [91] [IndicMedDialog: A Parallel Multi-Turn Medical Dialogue Dataset for Accessible Healthcare in Indic Languages](https://arxiv.org/abs/2605.13292)
*Shubham Kumar Nigam,Suparnojit Sarkar,Piyush Patel*
...
### [92] [CANTANTE: Optimizing Agentic Systems via Contrastive Credit Attribution](https://arxiv.org/abs/2605.13295)
*Tom Zehle*
...
### [93] [Tracing Persona Vectors Through LLM Pretraining](https://arxiv.org/abs/2605.13329)
*Viktor Moskvoretskii,Dominik Glandorf,Jorge Medina Moreira,Tanja Käser,Robert West*
...
### [94] [Probing Persona-Dependent Preferences in Language Models](https://arxiv.org/abs/2605.13339)
*Oscar Gilg,Pierre Beckmann,Daniel Paleka,Patrick Butlin*
...
### [95] [Query-Conditioned Test-Time Self-Training for Large Language Models](https://arxiv.org/abs/2605.13369)
*Chaehee Song,Minseok Seo,Yeeun Seong,Doyi Kim,Changick Kim*
...
### [96] [LLMs as annotators of credibility assessment in Danish asylum decisions: evaluating classification performance and errors beyond aggregated metrics](https://arxiv.org/abs/2605.13412)
*Galadrielle Humblot-Renaux,Mohammad N. S. Jahromi,Rohat Bakuri-Jørgensen,Marieke Anne Heyl,Asta S. Stage Jarlner,Maria Vlachou,Anna Murphy Høgenhaug,Desmond Elliott,Thomas Gammeltoft-Hansen,Thomas B. Moeslund*
...
### [97] [Continual Learning with Multilingual Foundation Model](https://arxiv.org/abs/2605.13415)
*Barathi Ganesh HB,Michal Ptaszynski,Rene Melendez,Juuso Eronen*
...
### [98] [Many-Shot CoT-ICL: Making In-Context Learning Truly Learn](https://arxiv.org/abs/2605.13511)
*Tsz Ting Chung,Lemao Liu,Mo Yu,Dit-Yan Yeung*
...
### [99] [Locale-Conditioned Few-Shot Prompting Mitigates Demonstration Regurgitation in On-Device PII Substitution with Small Language Models](https://arxiv.org/abs/2605.13538)
*Anuj Sadani,Deepak Kumar*
...
### [100] [RTLC -- Research, Teach-to-Learn, Critique: A three-stage prompting paradigm inspired by the Feynman Learning Technique that lifts LLM-as-judge accuracy on JudgeBench with no fine-tuning](https://arxiv.org/abs/2605.13695)
*Andrea Morandi*
...
### [101] [Children's English Reading Story Generation via Supervised Fine-Tuning of Compact LLMs with Controllable Difficulty and Safety](https://arxiv.org/abs/2605.13709)
*Qian Shen,Fanghua Cao,Min Yao,Shlok Gilda,Bonnie J. Dorr,Walter L. Leite*
...
### [102] [Where Does Reasoning Break? Step-Level Hallucination Detection via Hidden-State Transport Geometry](https://arxiv.org/abs/2605.13772)
*Tyler Alvarez,Ali Baheri*
...
### [103] [Negation Neglect: When models fail to learn negations in training](https://arxiv.org/abs/2605.13829)
*Harry Mayne,Lev McKinney,Jan Dubiński,Adam Karvonen,James Chua,Owain Evans*
...
### [104] [WARDEN: Endangered Indigenous Language Transcription and Translation with 6 Hours of Training Data](https://arxiv.org/abs/2605.13846)
*Ziheng Zhang,Yunzhong Hou,Naijing Liu,Liang Zheng*
...
### [108] [Persona-Model Collapse in Emergent Misalignment](https://arxiv.org/abs/2605.12850)
*Davi Bastos Costa,Renato Vicente*
...
### [109] [AcquisitionSynthesis: Targeted Data Generation using Acquisition Functions](https://arxiv.org/abs/2605.13149)
*Ishika Agarwal,Sofia Stoica,Emre Can Acikgoz,Pradeep Natarajan,Mahdi Namazifar,Jiaqi Ma,Dilek Hakkani-Tür*
...
### [111] [Utility-Oriented Visual Evidence Selection for Multimodal Retrieval-Augmented Generation](https://arxiv.org/abs/2605.13277)
*Weiqing Luo,Zongye Hu,Xiao Wang,Zhiyuan Yu,Haofeng Zhang,Ziyi Huang*
...
### [112] [IndicMedDialog: A Parallel Multi-Turn Medical Dialogue Dataset for Accessible Healthcare in Indic Languages](https://arxiv.org/abs/2605.13292)
*Shubham Kumar Nigam,Suparnojit Sarkar,Piyush Patel*
...
### [113] [Query-Conditioned Test-Time Self-Training for Large Language Models](https://arxiv.org/abs/2605.13369)
*Chaehee Song,Minseok Seo,Yeeun Seong,Doyi Kim,Changick Kim*
...
### [114] [Continual Learning with Multilingual Foundation Model](https://arxiv.org/abs/2605.13415)
*Barathi Ganesh HB,Michal Ptaszynski,Rene Melendez,Juuso Eronen*
...
### [115] [Pretraining Language Models with Subword Regularization: An Empirical Study of BPE Dropout in Low-Resource NLP](https://arxiv.org/abs/2605.13436)
*Ruan Visser,Trienko Grobler,Marcel Dunaiski*
...
### [116] [Children's English Reading Story Generation via Supervised Fine-Tuning of Compact LLMs with Controllable Difficulty and Safety](https://arxiv.org/abs/2605.13709)
*Qian Shen,Fanghua Cao,Min Yao,Shlok Gilda,Bonnie J. Dorr,Walter L. Leite*
...
### [117] [Dense vs Sparse Pretraining at Tiny Scale: Active-Parameter vs Total-Parameter Matching](https://arxiv.org/abs/2605.13769)
*Abdalrahman Wael*
...
### [118] [Negation Neglect: When models fail to learn negations in training](https://arxiv.org/abs/2605.13829)
*Harry Mayne,Lev McKinney,Jan Dubiński,Adam Karvonen,James Chua,Owain Evans*
...
### [119] [Think Twice, Act Once: Verifier-Guided Action Selection For Embodied Agents](https://arxiv.org/abs/2605.12620)
...
### [120] [Macro-Action Based Multi-Agent Instruction Following through Value Cancellation](https://arxiv.org/abs/2605.12655)
...
### [121] [Do Androids Dream of Breaking the Game? Systematically Auditing AI Agent Benchmarks with BenchJack](https://arxiv.org/abs/2605.12673)
...
### [122] [Revealing Interpretable Failure Modes of VLMs](https://arxiv.org/abs/2605.12674)
...
### [123] [Learning Transferable Latent User Preferences for Human-Aligned Decision Making](https://arxiv.org/abs/2605.12682)
...
### [124] [On the Size Complexity and Decidability of First-Order Progression](https://arxiv.org/abs/2605.12691)
...
### [125] [DisaBench: A Participatory Evaluation Framework for Disability Harms in Language Models](https://arxiv.org/abs/2605.12702)
...
### [126] [CHAL: Council of Hierarchical Agentic Language](https://arxiv.org/abs/2605.12718)
...
### [127] [BEHAVE: A Hybrid AI Framework for Real-Time Modeling of Collective Human Dynamics](https://arxiv.org/abs/2605.12730)
*Helene Malyutina*
...
### [128] [State-Centric Decision Process](https://arxiv.org/abs/2605.12755)
...
### [129] [PROMETHEUS: Automating Deep Causal Research Integrating Text, Data and Models](https://arxiv.org/abs/2605.12835)
*Sridhar Mahadevan*
...
### [130] [Multimodal Hidden Markov Models for Persistent Emotional State Tracking](https://arxiv.org/abs/2605.12838)
...
### [131] [Moltbook Moderation: Uncovering Hidden Intent Through Multi-Turn Dialogue](https://arxiv.org/abs/2605.12856)
...
### [132] [Beyond Cooperative Simulators: Generating Realistic User Personas for Robust Evaluation of LLM Agents](https://arxiv.org/abs/2605.12894)
...
### [133] [When Attention Closes: How LLMs Lose the Thread in Multi-Turn Interaction](https://arxiv.org/abs/2605.12922)
...
### [134] [Sustaining AI safety: Control-theoretic external impossibility, intrinsic necessity, and structural requirements](https://arxiv.org/abs/2605.12963)
*James M. Mazzu*
...
### [135] [Position: Agentic AI System Is a Foreseeable Pathway to AGI](https://arxiv.org/abs/2605.12966)
...
### [136] [Retrieval is Cheap, Show Me the Code: Executable Multi-Hop Reasoning for Retrieval-Augmented Generation](https://arxiv.org/abs/2605.12975)
...
### [137] [Useful Memories Become Faulty When Continuously Updated by LLMs](https://arxiv.org/abs/2605.12978)
...
### [138] [Retrieval-Augmented Tutoring for Algorithm Tracing and Problem-Solving in AI Education](https://arxiv.org/abs/2605.12988)
...
### [139] [MAP: A Map-then-Act Paradigm for Long-Horizon Interactive Agent Reasoning](https://arxiv.org/abs/2605.13037)
...
### [140] [An Agentic LLM-Based Framework for Population-Scale Mental Health Screening](https://arxiv.org/abs/2605.13046)
...
### [141] [GRACE: Gradient-aligned Reasoning Data Curation for Efficient Post-training](https://arxiv.org/abs/2605.13130)
...
### [142] [A Constraint Programming Approach for $n$-Day Lookahead Playoff Clinching](https://arxiv.org/abs/2605.13142)
...
### [143] [Strikingness-Aware Evaluation for Temporal Knowledge Graph Reasoning](https://arxiv.org/abs/2605.13153)
...
### [153] [Discrete Diffusion for Complex and Congested Multi-Agent Path Finding with Sparse Social Attention](https://arxiv.org/abs/2605.13296)
...
### [154] [Achieving Gold-Medal-Level Olympiad Reasoning via Simple and Unified Scaling](https://arxiv.org/abs/2605.13301)
...
### [155] [IdeaForge: A Knowledge Graph-Grounded Multi-Agent Framework for Cross-Methodology Innovation Analysis and Patent Claim Generation](https://arxiv.org/abs/2605.13311)
*Joy Bose*
...
### [156] [VERA-MH: Validation of Ethical and Responsible AI in Mental Health](https://arxiv.org/abs/2605.13318)
...
### [157] [Diversity of Extensions in Abstract Argumentation](https://arxiv.org/abs/2605.13332)
...
### [158] [Ego2World: Compiling Egocentric Cooking Videos into Executable Worlds for Belief-State Planning](https://arxiv.org/abs/2605.13335)
...
### [159] [Multi-Agent Systems in Emergency Departments: Validation Study on a ED Digital Twin](https://arxiv.org/abs/2605.13345)
...
### [160] [RS-Claw: Progressive Active Tool Exploration via Hierarchical Skill Trees for Remote Sensing Agents](https://arxiv.org/abs/2605.13391)
...
### [161] [TRIAGE: Evaluating Prospective Metacognitive Control in LLMs under Resource Constraints](https://arxiv.org/abs/2605.13414)
...
### [162] [Cognifold: Always-On Proactive Memory via Cognitive Folding](https://arxiv.org/abs/2605.13438)
...
### [163] [Assessing the Creativity of Large Language Models: Testing, Limits, and New Frontiers](https://arxiv.org/abs/2605.13450)
...
### [164] [MMSkills: Towards Multimodal Skills for General Visual Agents](https://arxiv.org/abs/2605.13527)
...
### [165] [AI-Generated Slides: Are They Good? Can Students Tell?](https://arxiv.org/abs/2605.13532)
...
### [166] [Scaling Retrieval-Augmented Reasoning with Parallel Search and Explicit Merging](https://arxiv.org/abs/2605.13534)
...
### [167] [RealICU: Do LLM Agents Understand Long-Context ICU Data? A Benchmark Beyond Behavior Imitation](https://arxiv.org/abs/2605.13542)
...
### [168] [Learning Local Constraints for Reinforcement-Learned Content Generators](https://arxiv.org/abs/2605.13570)
...
### [169] [Position: Assistive Agents Need Accessibility Alignment](https://arxiv.org/abs/2605.13579)
...
### [170] [Unweighted ranking for value-based decision making with uncertainty](https://arxiv.org/abs/2605.13601)
...
### [171] [How to Interpret Agent Behavior](https://arxiv.org/abs/2605.13625)
...
### [172] [Adaptive mine planning under geological uncertainty: A POMDP framework for sequential decision-making](https://arxiv.org/abs/2605.13702)
...
### [173] [ScioMind: Cognitively Grounded Multi-Agent Social Simulation with Anchoring-Based Belief Dynamics and Dynamic Profiles](https://arxiv.org/abs/2605.13725)
...
### [174] [Senses Wide Shut: A Representation-Action Gap in Omnimodal LLMs](https://arxiv.org/abs/2605.13737)
...
### [175] [Harnessing Agentic Evolution](https://arxiv.org/abs/2605.13821)
...
### [176] [History Anchors: How Prior Behavior Steers LLM Decisions Toward Unsafe Actions](https://arxiv.org/abs/2605.13825)
...
### [177] [Quantifying Sensitivity for Tree Ensembles: A symbolic and compositional approach](https://arxiv.org/abs/2605.13830)
...
### [178] [Beyond Cooperative Simulators: Generating Realistic User Personas for Robust Evaluation of LLM Agents](https://arxiv.org/abs/2605.12894)
*Harshita Chopra,Kshitish Ghate,Aylin Caliskan,Tadayoshi Kohno,Chirag Shah,Natasha Jaques*
...
### [180] [Achieving Gold-Medal-Level Olympiad Reasoning via Simple and Unified Scaling](https://arxiv.org/abs/2605.13301)
*Yafu Li,Runzhe Zhan,Haoran Zhang,Shunkai Zhang,Yizhuo Li,Zhilin Wang,Jiacheng Chen,Futing Wang,Xuyang Hu,Yuchen Fan,Bangjie Xu,Yucheng Su,Xinmiao Han,Chenxi Li,Haodi Lei,Yufeng Zhao,Zejin Lin,Qianjia Cheng,Tong Zhu,Xiaoye Qu,Ganqu Cui,Peng Ye,Yun Luo,Zhouchen Lin,Yu Qiao,Bowen Zhou,Ning Ding,Yu Cheng*
...
### [181] [Cognifold: Always-On Proactive Memory via Cognitive Folding](https://arxiv.org/abs/2605.13438)
*Suli Wang,Yiqun Duan,Yu Deng,Rundong Zhao,Dai Shi,Xinliang Zhou*
...
### [182] [Assessing the Creativity of Large Language Models: Testing, Limits, and New Frontiers](https://arxiv.org/abs/2605.13450)
*Samuel Schapiro,Alexi Gladstone,Jonah Black,Heng Ji*
...
### [183] [AI-Generated Slides: Are They Good? Can Students Tell?](https://arxiv.org/abs/2605.13532)
*Juho Leinonen,Lisa Zhang,Arto Hellas*
...
### [184] [RealICU: Do LLM Agents Understand Long-Context ICU Data? A Benchmark Beyond Behavior Imitation](https://arxiv.org/abs/2605.13542)
*Chengzhi Shen,Weixiang Shen,Tobias Susetzky,Chen,Chen,Jun Li,Yuyuan Liu,Xuepeng Zhang,Zhenyu Gong,Daniel Rueckert,Jiazhen Pan*
...
### [186] [Revealing Interpretable Failure Modes of VLMs](https://arxiv.org/abs/2605.12674)
*Isha Chaudhary,Vedaant V Jain,Kavya Sachdeva,Sayan Ranu,Gagandeep Singh*
...
### [187] [CHAL: Council of Hierarchical Agentic Language](https://arxiv.org/abs/2605.12718)
*Tommaso Giovannelli,Griffin D. Kent*
...
### [188] [An Agentic AI Framework with Large Language Models and Chain-of-Thought for UAV-Assisted Logistics Scheduling with Mobile Edge Computing](https://arxiv.org/abs/2605.13221)
*Hanwen Zhang,Dusit Niyato,Wei Zhang,Xin Lou,Malcolm Yoke Hean Low*
...
### [189] [Differentiable Learning of Lifted Action Schemas for Classical Planning](https://arxiv.org/abs/2605.13282)
*Jonas Reiter,Jakob Elias Gebler,Hector Geffner*
...
### [190] [Discrete Diffusion for Complex and Congested Multi-Agent Path Finding with Sparse Social Attention](https://arxiv.org/abs/2605.13296)
*Yuanzhe Wang,Tian Zhi,Zihang Wei,Hongguang Wang,Jiaming Guo,Yang Zhao,Zisheng Liu,Shiyu Quan,Xing Hu,Zidong Du,Yunji Chen*
...
### [192] [Learning Local Constraints for Reinforcement-Learned Content Generators](https://arxiv.org/abs/2605.13570)
*Debosmita Bhaumik,Julian Togelius,Georgios N. Yannakakis,Ahmed Khalifa*
...
### [193] [Harnessing Agentic Evolution](https://arxiv.org/abs/2605.13821)
*Jiayi Zhang,Yongfeng Gu,Jianhao Ruan,Maojia Song,Yiran Peng,Zhiguang Han,Jinyu Xiang,Zhitao Wang,Caiyin Yang,Yixi Ouyang,Bang Liu,Chenglin Wu,Yuyu Luo*
...
### [194] [Quantifying Sensitivity for Tree Ensembles: A symbolic and compositional approach](https://arxiv.org/abs/2605.13830)
*S. Akshay,Chaitanya Garg,Ashutosh Gupta,Kuldeep S. Meel,Ajinkya Naik*
...
### [196] [CAWI: Copula-Aligned Weight Initialization for Randomized Neural Networks](https://arxiv.org/abs/2605.12580)
...
### [197] [Towards Robust Federated Multimodal Graph Learning under Modality Heterogeneity](https://arxiv.org/abs/2605.12584)
...
### [198] [OceanCBM: A Concept Bottleneck Model for Mechanistic Interpretability in Ocean Forecasting](https://arxiv.org/abs/2605.12639)
...
### [199] [Learning to Decide with AI Assistance under Human-Alignment](https://arxiv.org/abs/2605.12646)
...
### [200] [Population Risk Bounds for Kolmogorov-Arnold Networks Trained by DP-SGD with Correlated Noise](https://arxiv.org/abs/2605.12648)
...
### [203] [Plan Before You Trade: Inference-Time Optimization for RL Trading Agents](https://arxiv.org/abs/2605.12653)
...
### [204] [scShapeBench: Discovering geometry from high dimensional scRNAseq data](https://arxiv.org/abs/2605.12662)
...
### [205] [ODRPO: Ordinal Decompositions of Discrete Rewards for Robust Policy Optimization](https://arxiv.org/abs/2605.12667)
...
### [206] [Parallel-in-Time Training of Recurrent Neural Networks for Dynamical Systems Reconstruction](https://arxiv.org/abs/2605.12683)
...
### [207] [A Unified Perspective for Learning Graph Representations Across Multi-Level Abstractions](https://arxiv.org/abs/2605.12685)
...
### [208] [IGT-OMD: Implicit Gradient Transport for Decision-Focused Learning under Delayed Feedback](https://arxiv.org/abs/2605.12693)
...
### [209] [Modeling Heterophily in Multiplex Graphs: An Adaptive Approach for Node Classification](https://arxiv.org/abs/2605.12699)
...
### [210] [UFO: A Domain-Unification-Free Operator Framework for Generalized Operator Learning](https://arxiv.org/abs/2605.12700)
...
### [211] [Do Fair Models Reason Fairly? Counterfactual Explanation Consistency for Procedural Fairness in Credit Decisions](https://arxiv.org/abs/2605.12701)
...
### [212] [Early Data Exposure Improves Robustness to Subsequent Fine-Tuning](https://arxiv.org/abs/2605.12705)
...
### [213] [A Resampling-Based Framework for Network Structure Learning in High-Dimensional Data](https://arxiv.org/abs/2605.12706)
...
### [214] [Spectral Energy Centroid: a Metric for Improving Performance and Analyzing Spectral Bias in Implicit Neural Representations](https://arxiv.org/abs/2605.12709)
...
### [215] [Layer-wise Representation Dynamics: An Empirical Investigation Across Embedders and Base LLMs](https://arxiv.org/abs/2605.12714)
...
### [216] [Scaling Laws for Mixture Pretraining Under Data Constraints](https://arxiv.org/abs/2605.12715)
...
### [217] [Before the Last Token: Diagnosing Final-Token Safety Probe Failures](https://arxiv.org/abs/2605.12726)
*Shravan Doda*
...
### [218] [From Generalist to Specialist Representation](https://arxiv.org/abs/2605.12733)
...
### [219] [ConRetroBert: EMA Stabilized Dual Encoders for Template-Based Single-Step Retrosynthesis](https://arxiv.org/abs/2605.12736)
...
### [220] [Learning with Rare Success but Rich Feedback via Reflection-Enhanced Self-Distillation](https://arxiv.org/abs/2605.12741)
...
### [221] [Low-Rank Adapters Initialization via Gradient Surgery for Continual Learning](https://arxiv.org/abs/2605.12752)
...
### [222] [Constraint-Aware Flow Matching: Decision Aligned End-to-End Training for Constrained Sampling](https://arxiv.org/abs/2605.12754)
...
### [223] [Predicting Channel Closures in the Lightning Network with Machine Learning](https://arxiv.org/abs/2605.12759)
...
### [224] [Multi-Quantile Regression for Extreme Precipitation Downscaling](https://arxiv.org/abs/2605.12762)
...
### [225] [State-Space NTK Collapse Near Bifurcations](https://arxiv.org/abs/2605.12763)
...
### [226] [Inference-Time Machine Unlearning via Gated Activation Redirection](https://arxiv.org/abs/2605.12765)
...
### [227] [WriteSAE: Sparse Autoencoders for Recurrent State](https://arxiv.org/abs/2605.12770)
*Jack Young*
...
### [228] [Graph-Based Financial Fraud Detection with Calibrated Risk Scoring and Structural Regularization](https://arxiv.org/abs/2605.12782)
...
### [229] [ToolMol: Evolutionary Agentic Framework for Multi-objective Drug Discovery](https://arxiv.org/abs/2605.12784)
...
### [230] [Identifying the nonlinear string dynamics with port-Hamiltonian neural networks](https://arxiv.org/abs/2605.12785)
...
### [231] [From Heuristics to Analytics: Forecasting Effort and Progress in Online Learning](https://arxiv.org/abs/2605.12788)
...
### [232] [SoK: A Comprehensive Analysis of the Current Status of Neural Tangent Generalization Attacks with Research Directions](https://arxiv.org/abs/2605.12792)
...
### [233] [Emergent and Subliminal Misalignment Through the Lens of Data-Mediated Transfer](https://arxiv.org/abs/2605.12798)
...
### [234] [Pitfalls of Unlabeled Disagreement-Based Drift Detection in Streaming Tree Ensembles](https://arxiv.org/abs/2605.12803)
...
### [235] [Discrete MeanFlow: One-Step Generation via Conditional Transition Kernels](https://arxiv.org/abs/2605.12805)
...
### [236] [Neurodata Without Boredom: Benchmarking Agentic AI for Data Reuse](https://arxiv.org/abs/2605.12808)
...
### [237] [Correcting Influence: Unboxing LLM Outputs with Orthogonal Latent Spaces](https://arxiv.org/abs/2605.12809)
...
### [238] [AGOP as Explanation: From Feature Learning to Per-Sample Attribution in Image Classifiers](https://arxiv.org/abs/2605.12816)
...
### [239] [Training Large Language Models to Predict Clinical Events](https://arxiv.org/abs/2605.12817)
...
### [240] [Hessian Matching for Machine-Learned Coarse-Grained Molecular Dynamics](https://arxiv.org/abs/2605.12823)
...
### [241] [Orthrus: Memory-Efficient Parallel Token Generation via Dual-View Diffusion](https://arxiv.org/abs/2605.12825)
...
### [242] [Quantifying Potential Observation Missingness in Inverse Reinforcement Learning](https://arxiv.org/abs/2605.12831)
...
### [243] [Discrete Stochastic Localization for Non-autoregressive Generation](https://arxiv.org/abs/2605.12836)
...
### [244] [Bayesian Model Merging](https://arxiv.org/abs/2605.12843)
...
### [245] [Multitask Multimodal Fusion with Tabular Foundation Models for Peak and Durability Prediction of Pertussis Booster Response](https://arxiv.org/abs/2605.12852)
*Divya Sitani*
...
### [246] [SMA: Submodular Modality Aligner For Data Efficient Multimodal Learning](https://arxiv.org/abs/2605.12872)
...
### [263] [Layer-wise Representation Dynamics: An Empirical Investigation Across Embedders and Base LLMs](https://arxiv.org/abs/2605.12714)
*Jingzhou Jiang,Yi Yang,Kar Yan Tam*
...
### [264] [Towards Robust Federated Multimodal Graph Learning under Modality Heterogeneity](https://arxiv.org/abs/2605.12584)
*Sirui Zhang,Haonan Wang,Xunkai Li,Zekai Chen,Shumeng Li,Hongchao Qin,Rong-Hua Li,Guoren Wang*
...
### [266] [Scaling Laws for Mixture Pretraining Under Data Constraints](https://arxiv.org/abs/2605.12715)
*Anastasiia Sedova,Skyler Seto,Natalie Schluter,Pierre Ablin*
...
### [267] [Decision Tree Learning on Product Spaces](https://arxiv.org/abs/2605.12983)
...
### [268] [WriteSAE: Sparse Autoencoders for Recurrent State](https://arxiv.org/abs/2605.12770)
*Jack Young*
...
### [269] [Learning to Decide with AI Assistance under Human-Alignment](https://arxiv.org/abs/2605.12646)
*Nina Corvelo Benz,Eleni Straitouri,Manuel Gomez-Rodriguez*
...
### [270] [Not Just RLHF: Why Alignment Alone Won't Fix Multi-Agent Sycophancy](https://arxiv.org/abs/2605.12991)
...
### [271] [Emergent and Subliminal Misalignment Through the Lens of Data-Mediated Transfer](https://arxiv.org/abs/2605.12798)
*Baris Askin,Muhammed Ustaomeroglu,Anupam Nayak,Gauri Joshi,Guannan Qu,Carlee Joe-Wong*
...
### [272] [Multi-Rollout On-Policy Distillation via Peer Successes and Failures](https://arxiv.org/abs/2605.12652)
*Weichen Yu,Xiaomin Li,Yizhou Zhao,Xiaoze Liu,Ruowang Zhang,Haixin Wang,Yinyi Luo,Chen Henry Wu,Gaurav Mittal,Matt Fredrikson,Yu Hu*
...
### [273] [DP-Muon: Differentially Private Optimization via Matrix-Orthogonalized Momentum](https://arxiv.org/abs/2605.12994)
...
### [274] [Training Large Language Models to Predict Clinical Events](https://arxiv.org/abs/2605.12817)
*Benjamin Turtel,Paul Wilczewski,Kris Skotheim*
...
### [275] [Plan Before You Trade: Inference-Time Optimization for RL Trading Agents](https://arxiv.org/abs/2605.12653)
*Eun Go,Rohan Deb,Arindam Banerjee*
...
### [276] [F-GRPO: Factorized Group-Relative Policy Optimization for Unified Candidate Generation and Ranking](https://arxiv.org/abs/2605.12995)
...
### [277] [ODRPO: Ordinal Decompositions of Discrete Rewards for Robust Policy Optimization](https://arxiv.org/abs/2605.12667)
*Nirmal Patel,Fei Wang,Inderjit Dhillon*
...
### [278] [Frequency Bias and OOD Generalization in Neural Operators under a Variable-Coefficient Wave Equation](https://arxiv.org/abs/2605.12997)
*Runlong Xie,An Luo*
...
### [279] [Parallel-in-Time Training of Recurrent Neural Networks for Dynamical Systems Reconstruction](https://arxiv.org/abs/2605.12683)
*Florian Hess,Florian Götz,Daniel Durstewitz*
...
### [280] [\emph{DRIFT}: A Benchmark for Task-Free Continual Graph Learning with Continuous Distribution Shifts](https://arxiv.org/abs/2605.12998)
...
### [281] [From Instance Selection to Fixed-Pool Data Recipe Search for Supervised Fine-Tuning](https://arxiv.org/abs/2605.12944)
*Haodong Wu,Jiahao Zhang,Lijie Hu,Yongqi Zhang*
...
### [282] [A Unified Perspective for Learning Graph Representations Across Multi-Level Abstractions](https://arxiv.org/abs/2605.12685)
*Mohamed Mahmoud Amar,Nairouz Mrabah,Mohamed Bouguessa,Abdoulaye Baniré Diallo*
...
### [283] [JEDI: Joint Embedding Diffusion World Model for Online Model-Based Reinforcement Learning](https://arxiv.org/abs/2605.13013)
...
### [284] [Controlling Logical Collapse in LLMs via Algebraic Ontology Projection over F2](https://arxiv.org/abs/2605.12968)
*Hisashi Miyashita,Mgnite Inc*
...
### [285] [Modeling Heterophily in Multiplex Graphs: An Adaptive Approach for Node Classification](https://arxiv.org/abs/2605.12699)
*Kamel Abdous,Nairouz Mrabah,Mohamed Bouguessa*
...
### [286] [Rethinking Efficient Graph Coarsening via a Non-Selfishness Principle](https://arxiv.org/abs/2605.13021)
...
### [287] [Understanding and Accelerating the Training of Masked Diffusion Language Models](https://arxiv.org/abs/2605.13026)
...
### [288] [Do Fair Models Reason Fairly? Counterfactual Explanation Consistency for Procedural Fairness in Credit Decisions](https://arxiv.org/abs/2605.12701)
*Gideon Popoola,John Sheppard*
...
### [289] [Offline Two-Player Zero-Sum Markov Games with KL Regularization](https://arxiv.org/abs/2605.13025)
...
### [290] [Large Language Models Lack Temporal Awareness of Medical Knowledge](https://arxiv.org/abs/2605.13045)
...
### [291] [From Generalist to Specialist Representation](https://arxiv.org/abs/2605.12733)
*Yujia Zheng,Fan Feng,Yuke Li,Shaoan Xie,Kevin Murphy,Kun Zhang*
...
### [292] [Understanding and Accelerating the Training of Masked Diffusion Language Models](https://arxiv.org/abs/2605.13026)
*Chunsan Hong,Sanghyun Lee,Chieh-Hsin Lai,Satoshi Hayakawa,Yuhta Takida,Yuki Mitsufuji,Seungryong Kim,Jong Chul Ye*
...
### [293] [FeatCal: Feature Calibration for Post-Merging Models](https://arxiv.org/abs/2605.13030)
...
### [295] [Multi-Quantile Regression for Extreme Precipitation Downscaling](https://arxiv.org/abs/2605.12762)
*Hamed Najafi,Gareth Lagerwall,Jayantha Obeysekera,Jason Liu*
...
### [296] [What Information Matters? Graph Out-of-Distribution Detection via Tri-Component Information Decomposition](https://arxiv.org/abs/2605.13032)
...
### [297] [LIFT: Last-Mile Fine-Tuning for Table Explicitation](https://arxiv.org/abs/2605.13424)
...
### [298] [WriteSAE: Sparse Autoencoders for Recurrent State](https://arxiv.org/abs/2605.12770)
*Jack Young*
...
### [299] [Large Language Models Lack Temporal Awareness of Medical Knowledge](https://arxiv.org/abs/2605.13045)
*Zihan Guan,Qiao Jin,Guangzhi Xiong,Fangyuan Chen,Mengxuan Hu,Qingyu Chen,Yifan Peng,Zhiyong Lu,Anil Vullikanti*
...
### [300] [Emergent and Subliminal Misalignment Through the Lens of Data-Mediated Transfer](https://arxiv.org/abs/2605.12798)
*Baris Askin,Muhammed Ustaomeroglu,Anupam Nayak,Gauri Joshi,Guannan Qu,Carlee Joe-Wong*
...
### [301] [Bridging Domain Gaps with Target-Aligned Generation for Offline Reinforcement Learning](https://arxiv.org/abs/2605.13054)
...
### [302] [Discrete MeanFlow: One-Step Generation via Conditional Transition Kernels](https://arxiv.org/abs/2605.12805)
*Fairoz Nower Khan,Nabuat Zaman Nahim,Md Sajid Ahmed,Ruiquan Huang,Peizhong Ju*
...
### [303] [Ergodic Trajectory Design by Learned Pushforward Maps: Provable Coverage via Conditional Flow Matching](https://arxiv.org/abs/2605.13063)
...
### [304] [OSDN: Improving Delta Rule with Provable Online Preconditioning in Linear Attention](https://arxiv.org/abs/2605.13473)
...
### [305] [Correcting Influence: Unboxing LLM Outputs with Orthogonal Latent Spaces](https://arxiv.org/abs/2605.12809)
*Shixing Yu,Promit Ghosal,Kyra Gan*
...
### [306] [Local Inverse Geometry Can Be Amortized](https://arxiv.org/abs/2605.13068)
...
### [307] [Effective Context in Transformers: An Analysis of Fragmentation and Tokenization](https://arxiv.org/abs/2605.13485)
...
### [308] [Spectral Flattening Is All Muon Needs: How Orthogonalization Controls Learning Rate and Convergence](https://arxiv.org/abs/2605.13079)
...
### [309] [Training Large Language Models to Predict Clinical Events](https://arxiv.org/abs/2605.12817)
*Benjamin Turtel,Paul Wilczewski,Kris Skotheim*
...
### [310] [Bayesian Nonparametric Mixed-Effect ODEs with Gaussian Processes](https://arxiv.org/abs/2605.13088)
...
### [312] [Orthrus: Memory-Efficient Parallel Token Generation via Dual-View Diffusion](https://arxiv.org/abs/2605.12825)
*Chien Van Nguyen,Chaitra Hegde,Van Cuong Pham,Ryan A. Rossi,Franck Dernoncourt,Thien Huu Nguyen*
...
### [313] [Margin-calibrated Classifier Guidance for Property-driven Synthesis Planning](https://arxiv.org/abs/2605.13101)
...
### [314] [Bayesian Model Merging](https://arxiv.org/abs/2605.12843)
*Kaiyang Li,Shaobo Han,Qing Su,Shihao Ji*
...
### [315] [MLGIB: Multi-Label Graph Information Bottleneck for Expressive and Robust Message Passing](https://arxiv.org/abs/2605.13126)
...
### [316] [Multi-Objective and Mixed-Reward Reinforcement Learning via Reward-Decorrelated Policy Optimization](https://arxiv.org/abs/2605.13641)
...
### [317] [ERPPO: Entropy Regularization-based Proximal Policy Optimization](https://arxiv.org/abs/2605.13131)
...
### [318] [Beyond Perplexity: A Geometric and Spectral Study of Low-Rank Pre-Training](https://arxiv.org/abs/2605.13652)
...
### [319] [RISED: A Pre-Deployment Safety Evaluation Framework for Clinical AI Decision-Support Systems](https://arxiv.org/abs/2605.12895)
*Rohith Reddy Bellibatlu*
...
### [320] [KAST-BAR: Knowledge-Anchored Semantically-Dynamic Topology Brain Autoregressive Modeling for Universal Neural Interpretation](https://arxiv.org/abs/2605.13133)
...
### [321] [Data Difficulty and the Generalization--Extrapolation Tradeoff in LLM Fine-Tuning](https://arxiv.org/abs/2605.12906)
*Siyuan Liu,Tinghong Chen,Xinghan Li,Yifei Wang,Jingzhao Zhang*
...
### [322] [Collaborating in Multi-Armed Bandits with Strategic Agents](https://arxiv.org/abs/2605.13145)
...
### [323] [The Expressivity Boundary of Probabilistic Circuits: A Comparison with Large Language Models](https://arxiv.org/abs/2605.12940)
*Zhiyu Zhao,Xuejie Liu,Muhan Zhang,Anji Liu*
...
### [324] [Understanding Generalization through Decision Pattern Shift](https://arxiv.org/abs/2605.13148)
...
### [325] [Controlling Logical Collapse in LLMs via Algebraic Ontology Projection over F2](https://arxiv.org/abs/2605.12968)
*Hisashi Miyashita,Mgnite Inc*
...
### [326] [Continual Fine-Tuning of Large Language Models via Program Memory](https://arxiv.org/abs/2605.13162)
...
### [327] [Revisiting Reinforcement Learning with Verifiable Rewards from a Contrastive Perspective](https://arxiv.org/abs/2605.12969)
*Feng Zhang,Xinhong Ma,Ziqiang Dong,Xi Leng,Jianfei Zhao,Xin Sun,Yang Yang,Guanjun Jiang*
...
### [328] [Finding the Weakest Link: Adversarial Attack against Multi-Agent Communications](https://arxiv.org/abs/2605.13170)
...
### [329] [CoRe-Gen: Robust Spectrum-to-Structure Generation under Imperfect Fingerprint Conditions](https://arxiv.org/abs/2605.12980)
*Tianbo Liu,Chixiang Lu,Jing Hao,Hengyu Zhang,Lifei Wang,Haibo Jiang,Xiaojuan Qi*
...
### [330] [Do Heavy Tails Help Diffusion? On the Subtle Trade-off Between Initialization and Training](https://arxiv.org/abs/2605.13175)
...
### [331] [Not Just RLHF: Why Alignment Alone Won't Fix Multi-Agent Sycophancy](https://arxiv.org/abs/2605.12991)
*Adarsh Kumarappan,Ananya Mujoo*
...
### [332] [Stable Attention Response for Reliable Precipitation Nowcasting](https://arxiv.org/abs/2605.13181)
...
### [333] [Rethinking Efficient Graph Coarsening via a Non-Selfishness Principle](https://arxiv.org/abs/2605.13021)
*Xu Bai,Bin Lu,Kun Zhang,Shengbo Chen,Xinbing Wang,Chenghu Zhou,Meng Jin*
...
### [334] [N-vium: Mixture-of-Exits Transformer for Accelerated Exact Generation](https://arxiv.org/abs/2605.13190)
...
### [335] [Understanding and Accelerating the Training of Masked Diffusion Language Models](https://arxiv.org/abs/2605.13026)
*Chunsan Hong,Sanghyun Lee,Chieh-Hsin Lai,Satoshi Hayakawa,Yuhta Takida,Yuki Mitsufuji,Seungryong Kim,Jong Chul Ye*
...
### [336] [ECG-NAT: A Self-supervised Neighborhood Attention Transformer for Multi-lead Electrocardiogram Classification](https://arxiv.org/abs/2605.13194)
...
### [337] [FeatCal: Feature Calibration for Post-Merging Models](https://arxiv.org/abs/2605.13030)
*Yanggan Gu,Shuo Cai,Zihao Wang,Wenjun Wang,Yuanyi Wang,Pengkai Wang,Sirui Huang,Su Lu,Jianmin Wu,Hongxia Yang*
...
### [338] [McCast: Memory-Guided Latent Drift Correction for Long-Horizon Precipitation Nowcasting](https://arxiv.org/abs/2605.13197)
...
### [339] [A Hybrid Tucker-LSTM Tensor Network Model for SOC Prediction in Electric Vehicles](https://arxiv.org/abs/2605.13200)
...
### [340] [Bridging Domain Gaps with Target-Aligned Generation for Offline Reinforcement Learning](https://arxiv.org/abs/2605.13054)
*Minung Kim,Jeongmo Kim,Gwanwoo Choi,Seungyul Han*
...
### [341] [Switching Successor Measures for Hierarchical Zero-shot Reinforcement Learning](https://arxiv.org/abs/2605.13207)
...
### [342] [Machine Learning-Driven Multimodal Spectroscopic Liquid Biopsy for Early Multicancer Detection](https://arxiv.org/abs/2605.13218)
...
### [344] [Mix, Don't Tune: Bilingual Pre-Training Outperforms Hyperparameter Search in Data-Constrained Settings](https://arxiv.org/abs/2605.13225)
...
### [345] [Teacher-Guided Policy Optimization for LLM Distillation](https://arxiv.org/abs/2605.13230)
...
### [346] [EMO: Frustratingly Easy Progressive Training of Extendable MoE](https://arxiv.org/abs/2605.13247)
...
### [347] [Margin-calibrated Classifier Guidance for Property-driven Synthesis Planning](https://arxiv.org/abs/2605.13101)
*Najwa Laabid,Vikas Garg*
...
### [348] [Unified generalization analysis for physics informed neural networks](https://arxiv.org/abs/2605.13260)
...
### [349] [MLGIB: Multi-Label Graph Information Bottleneck for Expressive and Robust Message Passing](https://arxiv.org/abs/2605.13126)
*Chaokai Wu,Haofu Shi,Ningxuan Ma,Jianghong Ma,Xiaofeng Zhang*
...
### [350] [Chem-GMNet: A Sphere-Native Geometric Transformer for Molecular Property Prediction](https://arxiv.org/abs/2605.13262)
...
### [351] [LightSplit: Practical Privacy-Preserving Split Learning via Orthogonal Projections](https://arxiv.org/abs/2605.13265)
...
### [352] [Stable Attention Response for Reliable Precipitation Nowcasting](https://arxiv.org/abs/2605.13181)
*Penghui Wen,Zexin Hu,Sen Zhang,Patrick Filippi,Xiaogang Zhu,Allen Benter,Thomas Bishop,Zhiyong Wang,Kun Hu*
...
### [354] [N-vium: Mixture-of-Exits Transformer for Accelerated Exact Generation](https://arxiv.org/abs/2605.13190)
*Aleksander Lorenc,Frédéric Berdoz,Joël Mathys,Roger Wattenhofer*
...
### [355] [Delightful Exploration](https://arxiv.org/abs/2605.13287)
*Ian Osband*
...
### [356] [ECG-NAT: A Self-supervised Neighborhood Attention Transformer for Multi-lead Electrocardiogram Classification](https://arxiv.org/abs/2605.13194)
*Mahsa Gazeran,Sayvan Soleymanbaigi,Fatemeh Daneshfar,Amjad Seyedi,Fardin Akhlaghian Tab*
...
### [357] [PaMM: Periodic Motif Memory for Atomistic Models with an Explicit Local-Structure Interface](https://arxiv.org/abs/2605.13297)
*Ryan Dong*
...
### [358] [McCast: Memory-Guided Latent Drift Correction for Long-Horizon Precipitation Nowcasting](https://arxiv.org/abs/2605.13197)
*Penghui Wen,Yu Luo,Lintao Wang,Mengwei He,Patrick Filippi,Thomas Francis Bishop,Zhiyong Wang*
...
### [359] [Safe Bayesian Optimization for Uncertain Correlations Matrices in Linear Models of Co-Regionalization](https://arxiv.org/abs/2605.13302)
...
### [360] [Teacher-Guided Policy Optimization for LLM Distillation](https://arxiv.org/abs/2605.13230)
*Xinyu Liu,Kechen Jiao,Chunyang Xiao,Runsong Zhao,Junhao Ruan,Bei Li,Jiahao Liu,Qifan Wang,Xin Chen,Jingang Wang,Tong Xiao,JingBo Zhu*
...
### [361] [MPINeuralODE: Multiple-Initial-Condition Physics-Informed Neural ODEs for Globally Consistent Dynamical System Learning](https://arxiv.org/abs/2605.13305)
...
### [362] [Supervised Deep Multimodal Matrix Factorization for Interpretable Brain Network Analysis](https://arxiv.org/abs/2605.13312)
...
### [363] [Delightful Exploration](https://arxiv.org/abs/2605.13287)
*Ian Osband*
...
### [364] [Shortcut Mitigation via Spurious-Positive Samples](https://arxiv.org/abs/2605.13340)
...
### [365] [Contextual Bandits for Resource-Constrained Devices using Probabilistic Learning](https://arxiv.org/abs/2605.13346)
...
### [366] [GeoFlowVLM: Geometry-Aware Joint Uncertainty for Frozen Vision-Language Embedding](https://arxiv.org/abs/2605.13352)
...
### [367] [Building Interactive Real-Time Agents with Asynchronous I/O and Speculative Tool Calling](https://arxiv.org/abs/2605.13360)
...
### [368] [Phasor Memory Networks: Stable Backpropagation Through Time for Scalable Explicit Memory](https://arxiv.org/abs/2605.13370)
*Sungwoo Goo,Hwi-yeol Yun,Sangkeun Jung*
...
### [369] [Beyond Oversquashing: Understanding Signal Propagation in GNNs Via Observables](https://arxiv.org/abs/2605.13383)
...
### [370] [Teaching and Learning under Deductive Errors](https://arxiv.org/abs/2605.13384)
...
### [371] [Support-Conditioned Flow Matching Is Kernel Smoothing](https://arxiv.org/abs/2605.13386)
*Daniel Matsui Smola*
...
### [373] [Taming the Long Tail: Rebalancing Adversarial Training via Adaptive Perturbation](https://arxiv.org/abs/2605.13395)
...
### [374] [Discovery of Hidden Miscalibration Regimes](https://arxiv.org/abs/2605.13484)
...
### [375] [The Diffusion Encoder](https://arxiv.org/abs/2605.13399)
...
### [376] [Trajectory-Level Data Augmentation for Offline Reinforcement Learning](https://arxiv.org/abs/2605.13401)
...
### [377] [HLS-Seek: QoR-Aware Code Generation for High-Level Synthesis via Proxy Comparative Reward Reinforcement Learning](https://arxiv.org/abs/2605.13536)
...
### [378] [When is Warmstarting Effective for Scaling Language Models?](https://arxiv.org/abs/2605.13405)
...
### [380] [Vector-Quantized Discrete Latent Factors Meet Financial Priors: Dynamic Cross-Sectional Stock Ranking Prediction for Portfolio Construction](https://arxiv.org/abs/2605.13407)
...
### [381] [DP-KFC: Data-Free Preconditioning for Privacy-Preserving Deep Learning](https://arxiv.org/abs/2605.13418)
...
### [382] [Decoupled and Divergence-Conditioned Prompt for Multi-domain Dynamic Graph Foundation Models](https://arxiv.org/abs/2605.13540)
...
### [383] [LIFT: Last-Mile Fine-Tuning for Table Explicitation](https://arxiv.org/abs/2605.13424)
*Divij Khaitan,Ashish Tiwari*
...
### [384] [Self-Supervised On-Policy Reinforcement Learning via Contrastive Proximal Policy Optimisation](https://arxiv.org/abs/2605.13554)
...
### [385] [Strategic PAC Learnability via Geometric Definability](https://arxiv.org/abs/2605.13426)
...
### [387] [Rescaled Asynchronous SGD: Optimal Distributed Optimization under Data and System Heterogeneity](https://arxiv.org/abs/2605.13434)
...
### [388] [Beyond Perplexity: A Geometric and Spectral Study of Low-Rank Pre-Training](https://arxiv.org/abs/2605.13652)
*Namrata Shivagunde,Vijeta Deshpande,Sherin Muckatira,Anna Rumshisky*
...
### [389] [Q-Flow: Stable and Expressive Reinforcement Learning with Flow-Based Policy](https://arxiv.org/abs/2605.13435)
*JaeHyeok Doo,Byeongguk Jeon,Seonghyeon Ye,Kimin Lee,Minjoon Seo*
...
### [390] [A Hierarchical Language Model with Predictable Scaling Laws and Provable Benefits of Reasoning](https://arxiv.org/abs/2605.13687)
...
### [391] [Efficient Sensor Fusion for Gesture Recognition on Resource-Constrained Devices](https://arxiv.org/abs/2605.13462)
...
### [392] [The WidthWall: A Strict Expressivity Hierarchy for Hypergraph Neural Networks](https://arxiv.org/abs/2605.13690)
...
### [393] [A Unified Three-Stage Machine Learning Framework for Diabetes Detection, Subtype Discrimination, and Cognitive-Metabolic Hypothesis Testing](https://arxiv.org/abs/2605.13464)
...
### [394] [Twincher: Bijective Representation Learning for Robust Inversion of Continuous Systems](https://arxiv.org/abs/2605.13470)
*Arkady Gonoskov*
...
### [395] [OSDN: Improving Delta Rule with Provable Online Preconditioning in Linear Attention](https://arxiv.org/abs/2605.13473)
*Chenyu Zhou,Hongpei Li,Yuerou Liu,Jianghao Lin,Dongdong Ge,Yinyu Ye*
...
### [396] [Robust and Explainable Bicuspid Aortic Valve Diagnosis Using Stacked Ensembles on Echocardiography](https://arxiv.org/abs/2605.13730)
...
### [398] [High-Rate Quantized Matrix Multiplication II](https://arxiv.org/abs/2605.13768)
...
### [399] [Effective Context in Transformers: An Analysis of Fragmentation and Tokenization](https://arxiv.org/abs/2605.13485)
*Amirmehdi Jafari Fesharaki,Mohammadamin Rami,Aslan Tchamkerten*
...
### [400] [Path-independent Flow Matching for Multi-parameter Generative Dynamics](https://arxiv.org/abs/2605.13487)
...
### [401] [MinT: Managed Infrastructure for Training and Serving Millions of LLMs](https://arxiv.org/abs/2605.13779)
...
### [402] [HLS-Seek: QoR-Aware Code Generation for High-Level Synthesis via Proxy Comparative Reward Reinforcement Learning](https://arxiv.org/abs/2605.13536)
*Qingyun Zou,Feng Yu,Hongshi Tan,Yao Chen,Bingsheng He,WengFai Wong*
...
### [403] [ENSEMBITS: an alphabet of protein conformational ensembles](https://arxiv.org/abs/2605.13789)
...
### [404] [Temper and Tilt Lead to SLOP: Reward Hacking Mitigation with Inference-Time Alignment](https://arxiv.org/abs/2605.13537)
*Ye Wang,Jing Liu,Toshiaki Koike-Akino*
...
### [405] [Di-BiLPS: Denoising induced Bidirectional Latent-PDE-Solver under Sparse Observations](https://arxiv.org/abs/2605.13790)
...
### [406] [Decoupled and Divergence-Conditioned Prompt for Multi-domain Dynamic Graph Foundation Models](https://arxiv.org/abs/2605.13540)
*Haonan Yuan,Qingyun Sun,Junhua Shi,Xingcheng Fu,Jianxin Li,Philip S. Yu*
...
### [407] [Improving Reproducibility in Evaluation through Multi-Level Annotator Modeling](https://arxiv.org/abs/2605.13801)
...
### [408] [Mixed neural posterior estimation for simulators with discrete and continuous parameters](https://arxiv.org/abs/2605.13551)
...
### [409] [Self-Supervised On-Policy Reinforcement Learning via Contrastive Proximal Policy Optimisation](https://arxiv.org/abs/2605.13554)
*Asim Osman,Sasha Abramowitz,Mark Bergh,Ulrich Armel Mbou Sob,Ruan John de Kock,Omayma Mahjoub,Oussama Hidaoui,Noah De Nicola,Arnol Manuel Fokam,Felix Chalumeau,Daniel Rajaonarivonivelomanantsoa,Siddarth Singh,Refiloe Shabe,Juan Claude Formanek,Simon Verster Du Toit,Arnu Pretorius*
...
### [410] [Topology-Preserving Neural Operator Learning via Hodge Decomposition](https://arxiv.org/abs/2605.13834)
...
### [411] [Uncertainty-Aware Prediction of Lung Tumor Growth from Sparse Longitudinal CT Data via Bayesian Physics-Informed Neural Networks](https://arxiv.org/abs/2605.13560)
...
### [412] [Spatiotemporal downscaling and nowcasting of urban land surface temperatures with deep neural networks](https://arxiv.org/abs/2605.13566)
...
### [413] [Dynamical Predictive Modelling of Cardiovascular Disease Progression Post-Myocardial Infarction via ECG-Trained Artificial Intelligence Model](https://arxiv.org/abs/2605.13568)
*Riccardo Cavarra,Lupo Lovatelli,Shaheim Ogbomo-Harmitt,Shahid Aziz,Adelaide De Vecchi,Andrew King,Oleg Aslanidi*
...
### [414] [Rethinking Generalization in Graph Neural Networks: A Structural Complexity Perspective](https://arxiv.org/abs/2605.13597)
...
### [415] [Deep Learning as Neural Low-Degree Filtering: A Spectral Theory of Hierarchical Feature Learning](https://arxiv.org/abs/2605.13612)
...
### [416] [Multimodal Graph-based Classification of Esophageal Motility Disorders](https://arxiv.org/abs/2605.13623)
...
### [417] [Achieving $ε^{-2}$ Sample Complexity for Single-Loop Actor-Critic under Minimal Assumptions](https://arxiv.org/abs/2605.13639)
...
### [418] [Multi-Objective and Mixed-Reward Reinforcement Learning via Reward-Decorrelated Policy Optimization](https://arxiv.org/abs/2605.13641)
*Yang Bai,Kaiyuan Liu,Ziyuan Zhuang,Jiahong Zhou,Rongxiang Weng,Xin Chen,Jingang Wang,Xunliang Cai*
...
### [419] [Beyond Perplexity: A Geometric and Spectral Study of Low-Rank Pre-Training](https://arxiv.org/abs/2605.13652)
*Namrata Shivagunde,Vijeta Deshpande,Sherin Muckatira,Anna Rumshisky*
...
### [420] [Graph Neural Networks with Triangle-Based Messages for the Multicut Problem](https://arxiv.org/abs/2605.13673)
...
### [421] [Three-Stage Learning Unlocks Strong Performance in Simple Models for Long-Term Time Series Forecasting](https://arxiv.org/abs/2605.13678)
...
### [422] [Sampling from Flow Language Models via Marginal-Conditioned Bridges](https://arxiv.org/abs/2605.13681)
...
### [423] [Scale-Sensitive Shattering: Learnability and Evaluability at Optimal Scale](https://arxiv.org/abs/2605.13684)
...
### [424] [A Hierarchical Language Model with Predictable Scaling Laws and Provable Benefits of Reasoning](https://arxiv.org/abs/2605.13687)
*Jason Gaitonde,Frederic Koehler,Elchanan Mossel,Joonhyung Shin,Allan Sly*
...
### [425] [The WidthWall: A Strict Expressivity Hierarchy for Hypergraph Neural Networks](https://arxiv.org/abs/2605.13690)
*Fengqing Jiang,Yuetai Li,Yichen Feng,Kaiyuan Zheng,Luyao Niu,Bhaskar Ramasubramanian,Basel Alomair,Linda Bushnell,Radha Poovendran*
...
### [426] [Polyhedral Instability Governs Regret in Online Learning](https://arxiv.org/abs/2605.13692)
...
### [427] [MILM: Large Language Models for Multimodal Irregular Time Series with Informative Sampling](https://arxiv.org/abs/2605.13711)
...
### [428] [Tight Sample Complexity Bounds for Entropic Best Policy Identification](https://arxiv.org/abs/2605.13717)
...
### [429] [Robust and Explainable Bicuspid Aortic Valve Diagnosis Using Stacked Ensembles on Echocardiography](https://arxiv.org/abs/2605.13730)
*Christos Chrysanthos Nikolaidis,Vasileios Sachpekidis,Nikolas Moustakidis,Theofilos Moustakidis,Pavlos S. Efraimidis*
...
### [430] [Distinguishing performance gains from learning when using generative AI](https://arxiv.org/abs/2605.13731)
...
### [431] [Learning POMDP World Models from Observations with Language-Model Priors](https://arxiv.org/abs/2605.13740)
...
### [432] [GHGbench: A Unified Multi-Entity, Multi-Task Benchmark for Carbon Emission Prediction](https://arxiv.org/abs/2605.13743)
...
### [433] [Min Generalized Sliced Gromov Wasserstein: A Scalable Path to Gromov Wasserstein](https://arxiv.org/abs/2605.13753)
...
### [434] [Fast and effective algorithms for fair clustering at scale](https://arxiv.org/abs/2605.13759)
...
### [435] [Toward AI-Driven Digital Twins for Metropolitan Floods: A Conditional Latent Dynamics Network Surrogate of the Shallow Water Equations](https://arxiv.org/abs/2605.13761)
...
### [436] [High-Rate Quantized Matrix Multiplication II](https://arxiv.org/abs/2605.13768)
*Or Ordentlich,Yury Polyanskiy*
...
### [437] [MinT: Managed Infrastructure for Training and Serving Millions of LLMs](https://arxiv.org/abs/2605.13779)
*Mind Lab,:,Song Cao,Vic Cao,Andrew Chen,Kaijie Chen,Cleon Cheng,Steven Chiang,Kaixuan Fan,Hera Feng,Huan Feng,Arthur Fu,Jun Gao,Hongquan Gu,Aaron Guan,Nolan Ho,Mutian Hong,Hailee Hou,Peixuan Hua,Charles Huang,Miles Jiang,Nora Jiang,Yuyi Jiang,Qiuyu Jin,Fancy Kong,Andrew Lei,Kyrie Lei,Alexy Li,Lucian Li,Ray Li,Theo Li,Zhihui Li,Jiayi Lin,Kairus Liu,Kieran Liu,Logan Liu,Xiang Liu,Irvine Lu,Maeve Luo,Runze Lv,Pony Ma,Verity Niu,Anson Qiu,Vincent Wang,Rio Yang,Maxwell Yao,Carrie Ye,Regis Ye,Wenlin Ye,Josh Ying,Danney Zeng,Yuhan Zhan,Anya Zhang,Di Zhang,Ruijia Zhang,Sueky Zhang,Ya Zhang,Wei Zhao,Ada Zhou,Changhai Zhou,Yuhua Zhou,Xinyue Zhu,Murphy Zhuang*
...
### [438] [Attention Once Is All You Need: Efficient Streaming Inference with Stateful Transformers](https://arxiv.org/abs/2605.13784)
*Victor Norgren*
...
### [439] [Interpretable Machine Learning for Antepartum Prediction of Pregnancy-Associated Thrombotic Microangiopathy Using Routine Longitudinal Laboratory Data](https://arxiv.org/abs/2605.13786)
...
### [440] [Force-Aware Neural Tangent Kernels for Scalable and Robust Active Learning of MLIPs](https://arxiv.org/abs/2605.13788)
...
### [441] [ENSEMBITS: an alphabet of protein conformational ensembles](https://arxiv.org/abs/2605.13789)
*Kaiwen Shi,Carlos Oliver*
...
### [442] [Di-BiLPS: Denoising induced Bidirectional Latent-PDE-Solver under Sparse Observations](https://arxiv.org/abs/2605.13790)
*Zhonghao Li,Chaoyu Liu,Qian Zhang*
...
### [443] [Improving Reproducibility in Evaluation through Multi-Level Annotator Modeling](https://arxiv.org/abs/2605.13801)
*Deepak Pandita,Flip Korn,Chris Welty,Christopher M. Homan*
...
### [444] [Provable Quantization with Randomized Hadamard Transform](https://arxiv.org/abs/2605.13810)
...
### [445] [Uncertainty-Driven Anomaly Detection for Psychotic Relapse Using Smartwatches: Forecasting and Multi-Task Learning Fusion](https://arxiv.org/abs/2605.13816)
...
### [446] [Reducing cross-sample prediction churn in scientific machine learning](https://arxiv.org/abs/2605.13826)
...
### [447] [QLAM: A Quantum Long-Attention Memory Approach to Long-Sequence Token Modeling](https://arxiv.org/abs/2605.13833)
...
### [448] [Topology-Preserving Neural Operator Learning via Hodge Decomposition](https://arxiv.org/abs/2605.13834)
*Dongzhe Zheng,Tao Zhong,Christine Allen-Blanchette*
