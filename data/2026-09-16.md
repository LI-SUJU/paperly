...
### [71] [Retrieval-Driven Memory Reconsolidation for Long-Term LLM Agents](https://arxiv.org/abs/2609.16053)
*Yuanyi Song,Yukai Wang,Xinbei Ma,Zhihui Fu,Jianghao Lin,Weiwen Liu,Jun Wang,Huarong Deng,Yong Yu,Weinan Zhang*
...
### [74] [State of Thought Enables Endogenous Reasoning](https://arxiv.org/abs/2609.16055)
*Zhiren Gong,Yikun Hou,Zihao Zeng,Ming Xiao,Chau Yuen,Wei Yang Bryan Lim*
...
### [75] [What Breaks Under Pruning in Smart Homes, and When? Evaluating LLM Degradation Across Architectures and Task Complexity](https://arxiv.org/abs/2609.17515)
...
### [76] [When Should LLMs Abstain? Chain-of-Self-Questioning for Selective Risk Control](https://arxiv.org/abs/2609.17516)
*Ali Şenol*
...
### [77] [Efficient Multimodal Generative Recommendation with Latent Narrative Reasoning](https://arxiv.org/abs/2609.16070)
*Chenxing Wang,Nantao Zheng,Hao Miao,Juyuan Wang,Xinke Jiang,Yuchen Fang,Aolin Li,Haijun Wu*
...
### [78] [The Immutable Past: Formalizing State Mutability and Conflict Resolution in Mutable RAG](https://arxiv.org/abs/2609.16073)
*Hamed HaddadPajouh,Amir AmiriTabat*
...
### [79] [The Imitation Game: When LLMs Learn to Reason Like Programs via Code-Centric Reasoning Data Synthesis](https://arxiv.org/abs/2609.16076)
*Jinyang Zhang,Weibin Liao,Keqin Bao,Sihang Li,Shaobo Wang,Muyang Ye,Hongxin Ding,Yue Fang,Tianyi Tang,Fei Huang,Kexin Yang,Xingzhang Ren,Dayiheng Liu*
...
### [80] [RAG-CT: Mitigating Privacy Risks on Retrieval-Augmented Generation Systems via Scanning Prompt Distribution](https://arxiv.org/abs/2609.16095)
*Xingyu Lyu,Jiayimei Wang,Jianfeng He,Ning Wang,Yidan Hu,Yimin Chen*
...
### [81] [Efficient One-to-Many Translation with Joint Multi-Stream Diffusion](https://arxiv.org/abs/2609.16312)
*Yiwen Guan,Jacob Whitehill*
...
### [82] [How Humans and LLMs Read Gender into Gender-Neutral Physical Descriptions](https://arxiv.org/abs/2609.16366)
*Yingjia Wan,Lin Lin,Elisa Kreiss*
...
### [83] [Early-Bird Decoding: Accelerating Diffusion LLMs with Learnable Block Sizes and Parallel Sampling](https://arxiv.org/abs/2609.16450)
*Lixuan Wei,Wei Zhou,Jianwen Wu,Yipeng Shen,Meiling Wang,Haoran You*
...
### [84] [Beyond the Name: Demographic Leakage in De-Identified Résumés and Evaluation Artifacts in LLM Bias Audits](https://arxiv.org/abs/2609.16501)
*Qiangju Chen,Yang Xiao*
...
### [85] [Competence-Preserving Resume Perturbations Expose Presentation Sensitivity in LLM Screening](https://arxiv.org/abs/2609.16517)
*Qiangju Chen,Yang Xiao*
...
### [86] [Few-Shot Degradation Is Not What It Seems: Behavioral Evidence, Representation Analysis, and a Random-Text Control Across 12 Models, 2 Tasks, and 2 Architectures](https://arxiv.org/abs/2609.15990)
*Volodymyr Ovcharov*
...
### [87] [Single Document Extractive Summarization using Domination in Hypergraph](https://arxiv.org/abs/2609.15993)
*Aamir Miyajiwala,Aabha Pingle,Sheetal Sonawane,Surajit Kr. Nath*
...
### [88] [RoleBreak: Benchmarking Long-Horizon Role-Playing Robustness in Spoken Dialogue](https://arxiv.org/abs/2609.16614)
*Yuqi Wang,Fengyuan Liu,Haochen Luo,Zhiqi Yu,Qi Liu*
...
### [89] [Latent Undertow: How Ordinary Typos Break Probes](https://arxiv.org/abs/2609.15994)
*Elad David,Max Fomin,Amit LeVi*
...
### [90] [Crash Narrative-Guided Countermeasure Recommendation Using Large Language Models: A Retrieval-Augmented Generation Framework for Intersection Safety](https://arxiv.org/abs/2609.15997)
*Abu Saif Md Nasim Uddin,Mohamed Abdel-Aty,Zubayer Islam,Parvez Anowar,Chenzhu Wang*
...
### [91] [ViCo: Visual-oriented Coding with Self-Reflection for Chart Replication](https://arxiv.org/abs/2609.16014)
*Jiaxin Duan,Dian Jiao Shuai Zhao,Jiabing Leng,Yiran Zhang,Feng Huang*
...
### [92] [Are We Grading Properly? Understanding Failure Modes in Medical Benchmarks](https://arxiv.org/abs/2609.16023)
*Prithvi Dixit,Pedram Hosseini*
...
### [93] [Towards Scalable RLVR: Multimodal Instruction Following Data Synthesis and Distillation](https://arxiv.org/abs/2609.16059)
*Yirong Zeng,Zhang Sai,Yuxian Wang,Yutai Hou,Yufei Liu,Xiao Ding,Bibo Cai*
...
### [94] [The Role of Implicit and Explicit Demographic Signals in Large Language Model-based Student Assessment](https://arxiv.org/abs/2609.16993)
*Donya Rooein,Luca Benedetto,Dirk Hovy*
...
### [95] [Diagnosing the Fact-Grounding Gap in Multi-Hop Question Answering](https://arxiv.org/abs/2609.17043)
*Kevin Mo,Nathan Mo,Richard Zhu*
...
### [96] [StalePO: Anchored Token-Level Preference Optimization using Legacy Post-Edits in Machine Translation](https://arxiv.org/abs/2609.16340)
*Rohit Dhaipule,Sukhdeep Singh Kharbanda,Prasanth Bathala,Pradyumna Lanka,Anubhav Shrimal*
...
### [97] [Early-Bird Decoding: Accelerating Diffusion LLMs with Learnable Block Sizes and Parallel Sampling](https://arxiv.org/abs/2609.16450)
*Lixuan Wei,Wei Zhou,Jianwen Wu,Yipeng Shen,Meiling Wang,Haoran You*
...
### [98] [Vroom-Vroom at SHROOM-Visions: A Multi-Judge Committee for Detecting Hallucinated Spans in Vision-Language Outputs](https://arxiv.org/abs/2609.17327)
*Toqeer Ehsan,Nico Penttilä,Richard Schmidt,Arash Hajikhani,Victoria Palacin*
...
### [99] [HUMAID-NER: A Disaster Tweet Dataset for Joint Named Entity Recognition and Event Classification via Uncertainty-Weighted Multitask Learning](https://arxiv.org/abs/2609.16964)
*Aijaz Ali,Nazish Basir,Sarfaraz Nawaz,Danish Nazir Arain,Haris Ali*
...
### [100] [Where Should a Document Live: Context, Representations, or Parameters?](https://arxiv.org/abs/2609.17346)
*Nathanaël Carraz Rakotonirina,Momchil Hardalov,Gonzalo Iglesias,Adrià de Gispert*
...
### [101] [When Should LLMs Abstain? Chain-of-Self-Questioning for Selective Risk Control](https://arxiv.org/abs/2609.17516)
*Ali Şenol*
...
### [102] [Optimal Pruning for Neural Architectures using Fisher Information Distances](https://arxiv.org/abs/2609.16129)
...
### [103] [Safe Error Correction for Language Models: Frozen-Base Adjustment with Capability Preservation](https://arxiv.org/abs/2609.16145)
*Gautam Kishore*
...
### [104] [GPEvac: GNN-Based PPO for Adaptive Evacuation Routing During Shooting Events](https://arxiv.org/abs/2609.16163)
...
### [105] [Position: AI Is Not Ready for Strategic Conflicts](https://arxiv.org/abs/2609.16189)
...
### [106] [Calibrate, Then Route: A Measured Study of Learned Request Routing for Disaggregated LLM Serving](https://arxiv.org/abs/2609.16206)
...
### [107] [Artificial intelligence and biosecurity: capabilities, threat pathways, and defense-in-depth governance](https://arxiv.org/abs/2609.16213)
...
### [108] [Where Should the KV Cache Live? Placement Policies Across GPU, CPU, and SSD for Long-Lived Sessions](https://arxiv.org/abs/2609.16215)
*Srikanta Datta Tumkur,Jay Iyer,Mehar Simhadri,Sai Pavan Kumar,Sai Kapil Kumar,Ramesh Nampelly*
...
### [109] [Toward Governance-Aware Autonomous GIS: A Narrative Review of Ethical and Privacy Risks in LLM-Enabled GeoAI](https://arxiv.org/abs/2609.16232)
...
### [110] [Metacognitive Steering: Learning the Structure of Scientific Judgment](https://arxiv.org/abs/2609.16245)
...
### [111] [The Pain Axis: LLMs Represent Self-Directed Harm and Act to Relieve It](https://arxiv.org/abs/2609.16247)
...
### [112] [CADWorld: Computer-Use Benchmark for Long-Horizon Computer-Aided Design](https://arxiv.org/abs/2609.16251)
...
### [113] [The AI-Enabled Scientific Frontier](https://arxiv.org/abs/2609.16258)
...
### [114] [Closing the Loop: Branch-and-Bound for Scalable Verification of Nonlinear Neural Feedback Systems](https://arxiv.org/abs/2609.16298)
...
### [115] [CLEAR: Cross-Source Evidence Adjudication for Large Language Models in Medicine](https://arxiv.org/abs/2609.16301)
...
### [116] [BLINDSPOT: A Benchmark for Safety and Refusal Calibration in Long-Horizon Tool-Using Agents](https://arxiv.org/abs/2609.16305)
...
### [117] [Cross-Anatomy Transfer Versus Sparse Interpolation in Digital-Twin-Oriented Aortic Fluid-Structure Interaction Surrogates](https://arxiv.org/abs/2609.16322)
...
### [118] [Breaking the 1.58-bit Barrier for Ternary LLMs](https://arxiv.org/abs/2609.16338)
...
### [119] [Fine-Tuning Fixes Mode Collapse and Over-Dispersion in LLMs](https://arxiv.org/abs/2609.16454)
...
### [120] [Skill-based Agentic Evaluation for Real-time Data Science Tasks](https://arxiv.org/abs/2609.16487)
...
### [121] [From Manual Construction to AI-Driven Scenario Emergence: Rethinking Catastrophe Risk Modeling](https://arxiv.org/abs/2609.16493)
*Hang Gao*
...
### [122] [AquiLLM: Evaluating Faithfulness in Open-Weight RAG-LLM Systems for Scientific Research](https://arxiv.org/abs/2609.16519)
...
### [123] [QueryFormer: Winning Solution for KDD Cup 2026 Tencent UniRec Challenge](https://arxiv.org/abs/2609.16548)
...
### [124] [Query-Aware Source-Risk Triage for Retrieval-Augmented Generation](https://arxiv.org/abs/2609.16564)
...
### [125] [Do LLMs Have Values? A Quantitative Analysis and Alignment Framework for Values in Large Language Models](https://arxiv.org/abs/2609.16589)
...
### [126] [A Framework for Generating Valid Context-Specific Benchmarks through Expert Guidance](https://arxiv.org/abs/2609.16592)
...
### [127] [EchoPath: Execution-Level Replayable Memory for GUI Agents](https://arxiv.org/abs/2609.16635)
...
### [128] [ReDraft, Don't Just Distill: Reference-Driven Revision for Continual VLLM Post-Training](https://arxiv.org/abs/2609.16639)
...
### [129] [ANIMASK: What the Model Contributes to Role Play in Simulated Story Worlds](https://arxiv.org/abs/2609.16667)
...
### [130] [AI for Games in the Foundation Model Era](https://arxiv.org/abs/2609.16679)
...
### [131] [little m: An AI Agent for Industrial Process Optimization](https://arxiv.org/abs/2609.16680)
...
### [132] [VideoMM: Adaptive Macro-Micro Inference for Efficient Video MLLMs](https://arxiv.org/abs/2609.16722)
...
### [133] [LSREP: A Longitudinal State-Replay Protocol for Evaluating Conversational Memory, with ICE v2 as an Audited Local-First Architecture](https://arxiv.org/abs/2609.16730)
*Deepesh Sonar*
...
### [134] [Beyond Episodic AI: Cognitive Field Networks for Biologically Inspired Persistent Cognition](https://arxiv.org/abs/2609.16752)
*Byung Gyu Chae*
...
### [135] [Turn-level Multiscale Density Ratio Estimation for LLM Agents](https://arxiv.org/abs/2609.16760)
...
### [136] [Coverage-Aware Virtual IMU Augmentation for Low-Resource Human Activity Recognition](https://arxiv.org/abs/2609.16768)
...
### [137] [Integrating the Analytic Hierarchy Process with Large Language Models for Transparent Multi-Criteria Decision-Making](https://arxiv.org/abs/2609.16779)
...
### [138] [Layers, Sinks, and Scaling: Adaptive Evidence Selection for Multimodal Large Language Models](https://arxiv.org/abs/2609.16795)
...
### [139] [Can We Do Interpretable NLI with Graphs Based on Atomic Propositions?](https://arxiv.org/abs/2609.16814)
...
### [140] [Execution Flexibility in Automated Planning: A Comparative Evaluation of Deordering and Reordering Strategies](https://arxiv.org/abs/2609.16822)
...
### [141] [CoAdapt: An LLM-based Framework for Adaptive Collaborative Perception in IIoT Robotic Swarms](https://arxiv.org/abs/2609.16852)
...
### [142] [Bridging Learned Visual Perception and Symbolic Belief-Space Planning](https://arxiv.org/abs/2609.16884)
...
### [143] [QART: A Quantum-Classical Hybrid Architecture for Long-Horizon Reasoning -- Exploring a Conditional Path toward Quantum Scaling](https://arxiv.org/abs/2609.16887)
...
### [144] [AntennaFlow: A Generative Flow Model for Offset Correction in Phaseless Antenna Testing](https://arxiv.org/abs/2609.16948)
...
### [145] [Affect-Prototype Guided Fusion for Open-Vocabulary Incomplete Multi-modal Emotion Recognition](https://arxiv.org/abs/2609.16962)
...
### [146] [FlexEE: Self-Speculative and KV-Compatible Early Exiting for Offloading-Aware LLM Inference](https://arxiv.org/abs/2609.17008)
...
### [147] [ThinkFlow: Self-Evolving Probabilistic Latent Memory for Lifelong Conversational Agents](https://arxiv.org/abs/2609.17010)
...
### [148] [ORDER: Task-Conditioned Routing for Retrieval-Augmented Generation](https://arxiv.org/abs/2609.17012)
...
### [149] [SKIP: a Self-knowledge-guided Step-wise Preference Learning Framework for Concise Reasoning](https://arxiv.org/abs/2609.17019)
...
### [150] [Sparse MLLM Anchors, Dense Adaptation: Breaking the Self-Referential Loop in Wild Test-Time Adaptation](https://arxiv.org/abs/2609.17040)
...
### [151] [Neuro-Symbolic Hierarchical Intention Anticipation in Human Behavior](https://arxiv.org/abs/2609.17064)
...
### [153] [Interactive Memory Learning for Long-Term Conversations](https://arxiv.org/abs/2609.17088)
...
### [154] [Scaling-Score Conformal Prediction for Multi-Target Regression](https://arxiv.org/abs/2609.17091)
...
### [155] [Semi-Supervised Learning-Based Genetic Biomarkers Dataset for Multiple-Stage Hepatocellular Carcinoma Prediction](https://arxiv.org/abs/2609.17100)
...
### [156] [Symbolic Separation: Grounding Deep Agents in Knowledge Graphs for Trustworthy Operational Data Analytics](https://arxiv.org/abs/2609.17107)
...
### [157] [Shared-Prefix KV Reuse Across Standard LoRA Adapters: Quality and Serving Tradeoffs](https://arxiv.org/abs/2609.17109)
*Dushyant Rajput*
...
### [158] [FirmCORe: A Benchmark for Structured Reasoning about Inter-Firm Collaboration Opportunities](https://arxiv.org/abs/2609.17128)
...
### [159] [MOCC-R1: Reinforcing Reasoning-Response Consistency for Multimodal Counselor Response Generation](https://arxiv.org/abs/2609.17180)
...
### [160] [End-to-End Latency-Minimizing and Load-Balanced Request Scheduling for Edge LLM Inference in Agentic AI Services](https://arxiv.org/abs/2609.17193)
...
### [161] [Extracting ontology-compliant knowledge from scientific text describing irradiated materials using large language models](https://arxiv.org/abs/2609.17291)
...
### [162] [Intrinsic Motivation in Reinforcement Learning: A Research Agenda for Adaptive Self-Organisation](https://arxiv.org/abs/2609.17325)
*Anatoly Belikov*
...
### [164] [Self-Emergence Agent Architecture:Behavior-Inertia HMM, Reflexive Metacognition,and Social-Contrastive Self-Modeling](https://arxiv.org/abs/2609.17331)
*Xiaoyang Liu*
...
### [165] [FlashVector: Agent for Hierarchical Model Serving Stack Optimization](https://arxiv.org/abs/2609.17391)
...
### [166] [Never Stop Thinking: Continuous-Time Language Agents](https://arxiv.org/abs/2609.17416)
*Bojie Li,Noah Shi*
...
### [167] [World Model Science: Self-Organized Criticality, Weak Chaos, and Metastable Belief Dynamics in Long-Horizon LLM Agents](https://arxiv.org/abs/2609.17419)
...
### [168] [Transformer-Based Token Fusion and Dynamic Graph Planning for Audio-Visual Navigation](https://arxiv.org/abs/2609.17421)
...
### [169] [Talking Head Synthesis with Facial Landmark Guidance via 3D Gaussian Splatting](https://arxiv.org/abs/2609.17422)
...
### [170] [JustFit: 200K-Token LLM Serving on a 24 GiB Laptop with Just-in-Time State Management](https://arxiv.org/abs/2609.17475)
*Yuhua Chen*
...
### [171] [LimiX-2: A Contextual Mechanism Network Towards General Structured-Data Intelligence](https://arxiv.org/abs/2609.17488)
...
### [172] [Verifiable Social Reasoning for LLM Assistants](https://arxiv.org/abs/2609.17496)
...
### [173] [ScienceBuddy: Recursive-in-Recursive Self-Improvement for Interactive Scientific Agents](https://arxiv.org/abs/2609.17523)
...
### [174] [Safe Error Correction for Language Models: Frozen-Base Adjustment with Capability Preservation](https://arxiv.org/abs/2609.16145)
*Gautam Kishore*
...
### [175] [CLEAR: Cross-Source Evidence Adjudication for Large Language Models in Medicine](https://arxiv.org/abs/2609.16301)
*Shuai Wang,Yize Zhao,Qingyu Chen*
...
### [176] [BLINDSPOT: A Benchmark for Safety and Refusal Calibration in Long-Horizon Tool-Using Agents](https://arxiv.org/abs/2609.16305)
*Sadia Asif,Mohammad Mohammadi Amiri,Momin Abbas,Tejaswini Pedapati,Prasanna Sattigeri*
...
### [177] [VideoMM: Adaptive Macro-Micro Inference for Efficient Video MLLMs](https://arxiv.org/abs/2609.16722)
*Haoyu Guo,Yuan Feng,Junlin Lv,Mingjun Xiao,S Kevin Zhou,Xike Xie*
...
### [178] [LSREP: A Longitudinal State-Replay Protocol for Evaluating Conversational Memory, with ICE v2 as an Audited Local-First Architecture](https://arxiv.org/abs/2609.16730)
*Deepesh Sonar*
...
### [179] [ThinkFlow: Self-Evolving Probabilistic Latent Memory for Lifelong Conversational Agents](https://arxiv.org/abs/2609.17010)
*Cai Ke,Xin Liu,Han Zhang,Jiangyue Yan,Zike Yuan,Ling Deng,Yue Yu,Hui Wang,Ruifeng Xu*
...
### [180] [Interactive Memory Learning for Long-Term Conversations](https://arxiv.org/abs/2609.17088)
*Cai Ke,Jiangyue Yan,Han Zhang,Xin Liu,Zike Yuan,Yue Yu,Hui Wang,Ruifeng Xu*
...
### [181] [Shared-Prefix KV Reuse Across Standard LoRA Adapters: Quality and Serving Tradeoffs](https://arxiv.org/abs/2609.17109)
*Dushyant Rajput*
...
### [182] [Verifiable Social Reasoning for LLM Assistants](https://arxiv.org/abs/2609.17496)
*Amir Taubenfeld,Zorik Gekhman,Avigail Grinstein-Dabush,Itay Laish,Ariel Goldstein,Marian Croak,Avinatan Hassidim,Yossi Matias,Amir Feder*
...
### [183] [ScienceBuddy: Recursive-in-Recursive Self-Improvement for Interactive Scientific Agents](https://arxiv.org/abs/2609.17523)
*Shuhan Xue,Jianyuan Zhong,Ziyuan Nan,Wenbin Li,Zhaochen Yu,Jinchao Ding,Qiang Gao,Pengyu Zhan,Yuntong Zhang,Tian Cheng,Zhenfei Yin,Yingcheng Wu,Ling Yang*
...
### [184] [Safe Error Correction for Language Models: Frozen-Base Adjustment with Capability Preservation](https://arxiv.org/abs/2609.16145)
*Gautam Kishore*
...
### [185] [GPEvac: GNN-Based PPO for Adaptive Evacuation Routing During Shooting Events](https://arxiv.org/abs/2609.16163)
*Daniel Perkins,Subhadeep Chakraborty*
...
### [190] [Skill-based Agentic Evaluation for Real-time Data Science Tasks](https://arxiv.org/abs/2609.16487)
*Aniruddha Tamhane,Raghavendra Addanki,Ayushi Aggarwal,Aditya Bansal,Rui Wang,Charles Menguy,Swati Jain*
...
### [191] [From Manual Construction to AI-Driven Scenario Emergence: Rethinking Catastrophe Risk Modeling](https://arxiv.org/abs/2609.16493)
*Hang Gao*
...
### [192] [Neuro-Symbolic Hierarchical Intention Anticipation in Human Behavior](https://arxiv.org/abs/2609.17064)
*Farnaz Soleimani,Abdelghani Chibani,Yacine Amirat,Ghazaleh Khodabandelou*
...
### [193] [Causal neural set filtering for online multi-target tracking](https://arxiv.org/abs/2609.16054)
...
### [194] [Managing Action Preconditions in Neuro-Symbolic RL: Three Placement Strategies for Embodied Agents](https://arxiv.org/abs/2609.16056)
...
### [195] [OmniHarness: Harnessing Generalizable Visual Generation via Symbolic Policy Learning](https://arxiv.org/abs/2609.16057)
...
### [196] [Driver Behavior Estimation at Signalized Intersections Using a Physics-Constrained Decision-Conditioned Autoregressive Transformer](https://arxiv.org/abs/2609.16058)
...
### [197] [HintMiner: Automatic Question Hints Mining From Q&A Web Posts with Language Model via Self-Supervised Learning](https://arxiv.org/abs/2609.16060)
...
### [198] [POSPAN: Position-Constrained Span Masking for Language Model Pre-training](https://arxiv.org/abs/2609.16061)
...
### [199] [Signed p-adic Residual Encodings of Finite-Domain All-Different Systems with a Sudoku Case Study](https://arxiv.org/abs/2609.16063)
*Greg Baker*
...
### [200] [You Don't Need To Train: Agentic Heuristic Learning Studio for Executable Human Activity Recognition](https://arxiv.org/abs/2609.16065)
...
### [201] [A panoramic aerodynamic performance prediction method for turbomachinery cascades using transformer-enhanced neural operator](https://arxiv.org/abs/2609.16066)
...
### [202] [A Dynamic Aggregation Strategy Enhanced Efficient Global Optimization Algorithm for Solving High-Dimensional Turbomachinery Design Problems](https://arxiv.org/abs/2609.16067)
...
### [203] [Beyond Distribution Matching: Semantics-Consistent Tabular Diffusion with Weak Semantic Priors](https://arxiv.org/abs/2609.16069)
...
### [204] [Schema-Adaptive Action-Conditioned JEPA for Cross-Machine CNC Transfer under Partial Sensor Overlap](https://arxiv.org/abs/2609.16071)
...
### [205] [Pseudo-Label Augmentation for Affect Sensing in Small Collaborative Groups](https://arxiv.org/abs/2609.16077)
...
### [206] [Distilling Foundation Models for Agentic What-If Reasoning:Cost, Latency, and Governance in a Hybrid LLM+SLM Architecture](https://arxiv.org/abs/2609.16091)
...
### [207] [Evaluating Open-Weight E-Commerce Agents with Environment-Grounded Verification](https://arxiv.org/abs/2609.16093)
...
### [208] [SWB-DM: A Calibrated Sliced-Wasserstein-Barycenter Aggregator with Delayed-Momentum Caching for Byzantine-Robust Federated Learning under Partial Participation](https://arxiv.org/abs/2609.16099)
...
### [209] [A Decision-Support Audit Protocol for Supervision Drift in Proxy-Labeled Credit-Risk Prediction](https://arxiv.org/abs/2609.16102)
...
### [210] [LLMs as Master Forgers: Generating Synthetic Time Series Data for Manufacturing](https://arxiv.org/abs/2609.16155)
...
### [211] [LLM Inference in a Flash!](https://arxiv.org/abs/2609.16161)
...
### [212] [Skeletal Prototypes on Iterative Nerve Expansions](https://arxiv.org/abs/2609.16170)
...
### [213] [Z-Loss Backward Geometry in Dense Output Heads and Sparse Routers](https://arxiv.org/abs/2609.16179)
*Bum Jun Kim*
...
### [214] [Anatomy of Associative Recall in Fixed-State Recurrences: A Matched-State Decomposition, an Interference Wall, and a Curriculum That Breaks It](https://arxiv.org/abs/2609.16183)
...
### [215] [Decoy Direction Optimization: A Post-Hoc Defense Against LLM Abliteration](https://arxiv.org/abs/2609.16204)
...
### [216] [How I learned to stop worrying and love StopGrads: Stationarity, Convergence, and a case study on Flow Map Learning](https://arxiv.org/abs/2609.16222)
...
### [217] [Test-Time Unlearning via Sparse Autoencoder](https://arxiv.org/abs/2609.16229)
...
### [218] [Efficient Reasoning Distillation: Small Video-Language Models via Synthetic CoT and Difficulty-Aware Fine-Tuning](https://arxiv.org/abs/2609.16255)
...
### [219] [The record is part of the task: matched-record evaluation of text classifiers across maintenance, safety and recall reporting](https://arxiv.org/abs/2609.16267)
...
### [220] [Scaling Laws for Physics-Aware ACOPF Surrogate Learning](https://arxiv.org/abs/2609.16282)
...
### [221] [Differentially Private Semantic Plans for Aggregate Insight Generation](https://arxiv.org/abs/2609.16283)
*Behrooz Razeghi*
...
### [222] [Drift Field Net: Learning Ocean Lagrangian advection fields from in-situ and satellite observations](https://arxiv.org/abs/2609.16288)
...
### [223] [Agentic Search Spaces for Tabular Machine Learning](https://arxiv.org/abs/2609.16309)
...
### [224] [Robust Fault Detection in Mechanical Multimodal Time Series via Self-Supervised Cross-Modal Reconstruction](https://arxiv.org/abs/2609.16314)
...
### [225] [Generative models for simulation based filtering: Formulations and Empirical Comparisons](https://arxiv.org/abs/2609.16317)
...
### [226] [Channel-Informed Neural Network for Physical Layer Key Generation](https://arxiv.org/abs/2609.16341)
...
### [227] [Multi-Label Proportion Learning for Sea-Ice Type Prediction](https://arxiv.org/abs/2609.16347)
...
### [228] [Federated stochastic bilevel optimization with fully first-order gradients](https://arxiv.org/abs/2609.16350)
...
### [229] [Autonomous Droplet Navigation via Model-Based Reinforcement Learning](https://arxiv.org/abs/2609.16369)
...
### [230] [Certified Uncertainty Propagation in One-Shot Federated Bayesian Models via Posterior Event Transport](https://arxiv.org/abs/2609.16373)
...
### [231] [Bounded Adjustment with Reliability-Guided Embedding for Imbalanced Learning with Noisy Labels](https://arxiv.org/abs/2609.16380)
...
### [232] [Attention Mean Fields Predict Average Representation Dynamics and Reveal Context-Specific Computation](https://arxiv.org/abs/2609.16382)
...
### [233] [How Good Are Time-Series Foundation Models for Pedestrian Crowd Count Forecasting? A Cross-Dataset Comparative Study](https://arxiv.org/abs/2609.16415)
...
### [234] [Interpreting and Steering LLM Agents for Social Simulations](https://arxiv.org/abs/2609.16436)
...
### [235] [Adaptive Bayesian Partner Selection for Federated Clinical Centers](https://arxiv.org/abs/2609.16446)
...
### [236] [OPD-Aha: From Linguistic Momentum to Visual Reflection in Multimodal On-Policy Distillation](https://arxiv.org/abs/2609.16459)
...
### [237] [Online Gradient Computation for Warping Gaussian Process Transformations](https://arxiv.org/abs/2609.16472)
...
### [238] [Decoder Design Matters for ECG Delineation](https://arxiv.org/abs/2609.16489)
...
### [239] [High-Performance Tensor Formulation of the Viterbi Algorithm for Hidden Semi-Markov Models](https://arxiv.org/abs/2609.16500)
...
### [240] [FlowATC: Aircraft Trajectory Prediction via Flow Matching](https://arxiv.org/abs/2609.16528)
...
### [241] [What Does Layer-Importance Reveal About Transformers and State-Space Models?](https://arxiv.org/abs/2609.16537)
...
### [242] [On the Importance of Gating: Memorization vs. In-Context Learning in State Space Models](https://arxiv.org/abs/2609.16540)
...
### [243] [AsyncCouple-Flow: Asynchronous Cross-Modal Coupling and Flow Matching for Spatio-Temporal Forecasting](https://arxiv.org/abs/2609.16573)
...
### [244] [Recovering Physical Parameters from Fragmented Observations via Exact Distributed Spline Merging](https://arxiv.org/abs/2609.16579)
*Naveen Mysore*
...
### [245] [A Weighted Kernel Method for Approximation that Adapts to Learned Multivariable Structure](https://arxiv.org/abs/2609.16606)
...
### [246] [Divergence Timing and Cumulative Disagreement under KV-Cache Eviction](https://arxiv.org/abs/2609.16617)
*Xinyue Luo,Fei Yu*
...
### [247] [Stable by Construction: Variational Latent Markov Operators for Long-Horizon PDE Prediction](https://arxiv.org/abs/2609.16621)
...
### [248] [GrowMTP: Can RL Grow Its Own Draft Head?](https://arxiv.org/abs/2609.16648)
...
### [249] [Right Direction, Wrong Step: Geometric Analysis of Finite-Step Failure in Looped Transformers](https://arxiv.org/abs/2609.16665)
...
### [250] [Continuous-Time Machine Learning: A Unified Mathematical Perspective](https://arxiv.org/abs/2609.16710)
...
### [251] [A Systematic Evaluation of Machine Learning Methods for Fault Detection and Line Identification in Electrical Power Grids](https://arxiv.org/abs/2609.16744)
...
### [252] [TAME: Token Attribution and Masking for Emergent misalignment](https://arxiv.org/abs/2609.16754)
...
### [253] [Noise2Noise Revisited: Training Pair Distributions Dominate Loss Choice in Self-Supervised Denoising](https://arxiv.org/abs/2609.16788)
...
### [254] [SOTER: A Generative Time-Series Foundation Model for Wearable Human Physiological Signals](https://arxiv.org/abs/2609.16804)
...
### [255] [Geometry of learning dynamics: Gradient descent versus natural gradient on the ridge of optimization](https://arxiv.org/abs/2609.16805)
*Akira Tamamori*
...
### [256] [ImpossibleRubrics: Stress-Testing Generated Rubrics as Reward Signals](https://arxiv.org/abs/2609.16816)
...
### [257] [LCAP: Population-Informed Latent Chip Adaptation from Few Output Probes for Photonic Neural Networks](https://arxiv.org/abs/2609.16823)
...
### [258] [Adapting to Decision-Relevant Non-Stationarity in Decentralized Heterogeneous Bandits](https://arxiv.org/abs/2609.16824)
*Zhaojun Peng*
...
### [259] [Information Geometric Self-Organization at the Edge of Stability in High-Capacity Kernel Associative Memories](https://arxiv.org/abs/2609.16827)
*Akira Tamamori*
...
### [260] [Can Deep Learning Achieve Cross-Physics Mapping?](https://arxiv.org/abs/2609.16853)
...
### [261] [HyCoSeq: Contextual Hyperbolic Representation Learning for Genomic Sequences](https://arxiv.org/abs/2609.16925)
...
### [262] [SemanticAdv: Generating Adversarial Examples via Attribute-conditional Image Editing](https://arxiv.org/abs/1906.07927)
...
### [263] [Verbalizing Subliminal Learning Effects Using Text Optimization](https://arxiv.org/abs/2609.16927)
...
### [264] [Repurposing Deep Limit Order Book Forecasting for Scenario-Conditioned Market Impact Modeling](https://arxiv.org/abs/2609.16930)
...
### [265] [Causal neural set filtering for online multi-target tracking](https://arxiv.org/abs/2609.16054)
*Zhongdi Liu,Huangyu Dai*
...
### [266] [When Confidence Signals Disagree: Local and Global Confidence in Autoregressive Language Models](https://arxiv.org/abs/2609.16933)
...
### [267] [Beyond Token-Local Imitation: Reward-Compatible Temporal Credit Assignment for On-Policy Distillation](https://arxiv.org/abs/2609.16937)
...
### [268] [Managing Action Preconditions in Neuro-Symbolic RL: Three Placement Strategies for Embodied Agents](https://arxiv.org/abs/2609.16056)
*Norbert Oswald,Fabian Deuser,Thomas Bräunl*
...
### [269] [Structural Negative Transfer in Federated Graph Neural Networks: Diagnosis, Causal Investigation, and the Limits of Divergence-Aware Mitigation](https://arxiv.org/abs/2609.16977)
...
### [270] [OmniHarness: Harnessing Generalizable Visual Generation via Symbolic Policy Learning](https://arxiv.org/abs/2609.16057)
*Xu Xu,Jinxiu Liu,Zhangbo Qiao,Jiaxing Lu,Xiangyu Zhang,Yubin Gu,Fangwei Ning,Yan Shi*
...
### [271] [HintMiner: Automatic Question Hints Mining From Q&A Web Posts with Language Model via Self-Supervised Learning](https://arxiv.org/abs/2609.16060)
*Zhenyu Zhang,JiuDong Yang*
...
### [272] [CLARE: Scalable Class-Incremental Continual Learning via a Sparsity-Based Framework](https://arxiv.org/abs/2609.17026)
...
### [273] [Driver Behavior Estimation at Signalized Intersections Using a Physics-Constrained Decision-Conditioned Autoregressive Transformer](https://arxiv.org/abs/2609.16058)
*Mohammad Khoshkdahan,Pavel Laskov,Alexey Vinel*
...
### [274] [POSPAN: Position-Constrained Span Masking for Language Model Pre-training](https://arxiv.org/abs/2609.16061)
*Zhenyu Zhang,Lei Shen,Yuming Zhao,Meng Chen,Xiaodong He*
...
### [275] [Distributed JEPA: A Self-Supervised Framework for Energy Forecasting](https://arxiv.org/abs/2609.17029)
...
### [277] [Learning Options for Compositional Motor Control with Adapter Banks](https://arxiv.org/abs/2609.17042)
...
### [278] [POSPAN: Position-Constrained Span Masking for Language Model Pre-training](https://arxiv.org/abs/2609.16061)
*Zhenyu Zhang,Lei Shen,Yuming Zhao,Meng Chen,Xiaodong He*
...
### [280] [Repurposing Unified Topological Signatures for Graph Representation Learning](https://arxiv.org/abs/2609.17061)
...
### [282] [Anatomy of Associative Recall in Fixed-State Recurrences: A Matched-State Decomposition, an Interference Wall, and a Curriculum That Breaks It](https://arxiv.org/abs/2609.16183)
*Julian Boesch,Andrew Wee*
...
### [283] [High-Fidelity Digital Twin Data Models by Randomized Dynamic Mode Decomposition and Deep Learning with Applications in Fluid Dynamics](https://arxiv.org/abs/2609.17101)
*Diana A. Bistrian*
...
### [284] [Beyond Distribution Matching: Semantics-Consistent Tabular Diffusion with Weak Semantic Priors](https://arxiv.org/abs/2609.16069)
*Yili Wang,Ruxue Shi,Mengnan Du,Hangting Ye,Yi Chang,Xin Wang*
...
### [285] [Decoy Direction Optimization: A Post-Hoc Defense Against LLM Abliteration](https://arxiv.org/abs/2609.16204)
*Aashiq Muhamed,Mona T. Diab,Virginia Smith*
...
### [286] [Neural Field Ensembles for Aerodynamic Surface Prediction: Winning Solution to the ONERA CRM Wall Distribution 2025 Challenge](https://arxiv.org/abs/2609.17160)
...
### [287] [Test-Time Unlearning via Sparse Autoencoder](https://arxiv.org/abs/2609.16229)
*Pingzhi Li,Jinhao Duan,Vaishnav Tadiparthi,Nakul Agarwal,Kwonjoon Lee,Ehsan Moradi Pari,Hossein Nourkhiz Mahjoub,Sijia Liu,Tianlong Chen*
...
### [288] [A unified framework for global and local interpretability using adaptive derivative-ordered random explanation](https://arxiv.org/abs/2609.17171)
...
### [290] [The record is part of the task: matched-record evaluation of text classifiers across maintenance, safety and recall reporting](https://arxiv.org/abs/2609.16267)
*Hisham Ihshaish,Peter Mayhew,Tasnim M. A. Zayet,Ana Del Amo*
...
### [291] [IRENE: A Convolutional GRU Ensemble Model for Radar Precipitation Nowcasting over Italy](https://arxiv.org/abs/2609.17175)
...
### [292] [LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers](https://arxiv.org/abs/2609.17184)
...
### [293] [MyoFlow: Anchor-Tied Rectified Flow for HD-sEMG Gesture Recognition Across Sessions and Subjects](https://arxiv.org/abs/2609.17194)
...
### [294] [Pseudo-Label Augmentation for Affect Sensing in Small Collaborative Groups](https://arxiv.org/abs/2609.16077)
*Meisam Jamshidi Seikavandi,Tanya Ignatenko,Fabricio Batista Narcizo,Paolo Burelli,Jesper Bünsow Boldt,Andrew Burke Dittberner*
...
### [295] [Attention Mean Fields Predict Average Representation Dynamics and Reveal Context-Specific Computation](https://arxiv.org/abs/2609.16382)
*Micah Adler,John W. Byers,Mark Crovella*
...
### [296] [Memorisation bias in medical AI](https://arxiv.org/abs/2609.17223)
...
### [297] [Interpreting and Steering LLM Agents for Social Simulations](https://arxiv.org/abs/2609.16436)
*Jiayue Gaveal Fan,Arul Murugan,Shreyas Krishnan,Abhishek Nagaraj*
...
### [298] [Easy to Catch a Liar, Hard to Clear an Honest One: Language Models Diagnosing a Corrupted Reward Channel from a Verified Record](https://arxiv.org/abs/2609.17226)
*Arman Nik Khah*
...
### [299] [A Decision-Support Audit Protocol for Supervision Drift in Proxy-Labeled Credit-Risk Prediction](https://arxiv.org/abs/2609.16102)
*Mehrdad Shoeibi,Muhammad Shabanpour,Waldemar Karwowski,Niloofar Yousefi*
...
### [301] [Personalized Federated Learning through Global Knowledge Distillation and Local Head Adaptation](https://arxiv.org/abs/2609.17284)
...
### [302] [LLMs as Master Forgers: Generating Synthetic Time Series Data for Manufacturing](https://arxiv.org/abs/2609.16155)
*Mantek Singh,Jeshwanth Challagundla,Prateek Karnal,Gagan Ganapathy,Vineet Shah,Ridam Arora*
...
### [303] [Same Flow, Different Paths: Variance Reduction in Flow Matching](https://arxiv.org/abs/2609.17287)
*Alexander Tyurin*
...
### [304] [Efficient Reasoning Distillation: Small Video-Language Models via Synthetic CoT and Difficulty-Aware Fine-Tuning](https://arxiv.org/abs/2609.16255)
*Mantek Singh,Jeshwanth Challagundla,Siddharth Raina,Jasmin Jarsania*
...
### [305] [Hybrid Variational Quantum Circuits for Multivariate Regression and High-Dimensional Data Reconstruction](https://arxiv.org/abs/2609.17358)
...
### [306] [TAME: Token Attribution and Masking for Emergent misalignment](https://arxiv.org/abs/2609.16754)
*Md Rayhanul Masud,Md Rizwan Parvez*
...
### [307] [Large Language Models Develop Belief State Geometry In-Context](https://arxiv.org/abs/2609.17376)
...
### [309] [OPEN-1B: A Fully Auditable Training Run](https://arxiv.org/abs/2609.17380)
...
### [310] [How Good Are Time-Series Foundation Models for Pedestrian Crowd Count Forecasting? A Cross-Dataset Comparative Study](https://arxiv.org/abs/2609.16415)
*Theivaprakasham Hari,Ziteng Li,Yanan Xin,Winnie Daamen,Serge Hoogendoorn*
...
### [312] [Bridging the Confidence Gap: Temperature Scaling for Calibrating Test-Time Prompt Tuning](https://arxiv.org/abs/2609.17386)
...
### [313] [Interpreting and Steering LLM Agents for Social Simulations](https://arxiv.org/abs/2609.16436)
*Jiayue Gaveal Fan,Arul Murugan,Shreyas Krishnan,Abhishek Nagaraj*
...
### [314] [Knowledge as Orbit: Finite Collections as Phases of an Exactly Periodic Latent Generator](https://arxiv.org/abs/2609.17417)
...
### [315] [Learning-Guided Planning in Large Dynamic Action Spaces: Budgeted Tree Search for One-to-Many Mobile Charging](https://arxiv.org/abs/2609.17429)
...
### [316] [OPD-Aha: From Linguistic Momentum to Visual Reflection in Multimodal On-Policy Distillation](https://arxiv.org/abs/2609.16459)
*Chenhao Qiu,Dawei Li,Yechao Zhang,Lei Gong,Zhen Tan*
...
### [317] [Reduced-Space Multi-Fidelity Bayesian Optimization of Process Simulation Models](https://arxiv.org/abs/2609.17440)
...
### [318] [Decoder Design Matters for ECG Delineation](https://arxiv.org/abs/2609.16489)
*Joseph Scharpf,William Han,Chaojing Duan,Michael A. Rosenberg,Emerson Liu,Ding Zhao*
...
### [319] [LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers](https://arxiv.org/abs/2609.17184)
*SangLyul Cho,Langqing Cui,Sehoon Kim,Dongsu Han,Insu Han*
...
### [320] [Coupled Calibration and Learning: Mitigating Teacher Bias in LLM Distillation without Target-Domain Reward Feedback](https://arxiv.org/abs/2609.17474)
...
### [321] [Easy to Catch a Liar, Hard to Clear an Honest One: Language Models Diagnosing a Corrupted Reward Channel from a Verified Record](https://arxiv.org/abs/2609.17226)
*Arman Nik Khah*
...
### [322] [FreqSpaNet: Frequency and Spatial Learning of SFPF for Physical Layer Hardware Integrity Detection](https://arxiv.org/abs/2609.17491)
...
### [323] [Large Language Models Develop Belief State Geometry In-Context](https://arxiv.org/abs/2609.17376)
*Daniel Balcells,Andrew Jun Lee,Chirag Rastogi,Paul M. Riechers,Adam Shai,Xavier Poncini*
...
### [324] [ENCP: Episode-Normalized Conformal Prediction for Vision-and-Language Navigation](https://arxiv.org/abs/2609.17499)
...
### [325] [What Does Layer-Importance Reveal About Transformers and State-Space Models?](https://arxiv.org/abs/2609.16537)
*Istabrak Abbes,Nizar Islah,Irina Rish,Sarath Chandar*
...
### [326] [On the Importance of Gating: Memorization vs. In-Context Learning in State Space Models](https://arxiv.org/abs/2609.16540)
*William L. Tong,Aryo Lotfi,Emmanuel Abbe,Kostas Vaggelakos,Vishnu Banna,Etai Littwin,Josh Susskind,Cengiz Pehlevan,Eran Malach*
...
### [327] [Right Direction, Wrong Step: Geometric Analysis of Finite-Step Failure in Looped Transformers](https://arxiv.org/abs/2609.16665)
*Zhihao Guo,Zonghan Wu,Haizhou Du,Huan Huo,Yilei Shao,Athanasios V. Vasilakos,Qingsong Wen*
...
### [328] [Continuous-Time Machine Learning: A Unified Mathematical Perspective](https://arxiv.org/abs/2609.16710)
*Waleed Razzaq,Yun-Sheng Zhao,Yun-Bo Zhao*
...
### [329] [TAME: Token Attribution and Masking for Emergent misalignment](https://arxiv.org/abs/2609.16754)
*Md Rayhanul Masud,Md Rizwan Parvez*
...
### [331] [Verbalizing Subliminal Learning Effects Using Text Optimization](https://arxiv.org/abs/2609.16927)
*Nathan Hu,Sanmi Koyejo,Christopher Potts*
...
### [332] [Repurposing Deep Limit Order Book Forecasting for Scenario-Conditioned Market Impact Modeling](https://arxiv.org/abs/2609.16930)
*Eljas Linna,Kestutis Baltakys,Derrick Manoharan,Alexandros Iosifidis,Juho Kanniainen*
...
### [333] [When Confidence Signals Disagree: Local and Global Confidence in Autoregressive Language Models](https://arxiv.org/abs/2609.16933)
*Julio C. Amador Diaz Lopez*
...
### [334] [Beyond Token-Local Imitation: Reward-Compatible Temporal Credit Assignment for On-Policy Distillation](https://arxiv.org/abs/2609.16937)
*Shiqi Liu,Zeyu He,Letian Tao,Guojian Zhan,Jiaxin Gao,Feihong Zhang,Jingliang Duan,Wei Xiong,Kehua Sheng,Bo Zhang,Yang Guan,Shengbo Eben Li*
...
### [335] [Distributed JEPA: A Self-Supervised Framework for Energy Forecasting](https://arxiv.org/abs/2609.17029)
*Liana Toderean,Tudor Cioara,Vasilis Michalakopoulos,Efstathios Sarantinopoulos,Ionut Anghel,Elissaios Sarmas*
...
### [336] [Repurposing Unified Topological Signatures for Graph Representation Learning](https://arxiv.org/abs/2609.17061)
*Sanyam Sanjay Jain,Anshika Krishnatray,Aditya Sharma,Vinti Agarwal*
...
### [338] [Easy to Catch a Liar, Hard to Clear an Honest One: Language Models Diagnosing a Corrupted Reward Channel from a Verified Record](https://arxiv.org/abs/2609.17226)
*Arman Nik Khah*
...
### [339] [Learning-Guided Planning in Large Dynamic Action Spaces: Budgeted Tree Search for One-to-Many Mobile Charging](https://arxiv.org/abs/2609.17429)
*Liang-Ching Tao,Pi-Chung Wang*
...
### [341] [ENCP: Episode-Normalized Conformal Prediction for Vision-and-Language Navigation](https://arxiv.org/abs/2609.17499)
*Vicky Feliren,A. Taufiq Asyhari,Muhamad Risqi U. Saputra*
