...
### [51] [MedStruct-S: A Benchmark for Key Discovery, Key-Conditioned QA and Semi-Structured Extraction from OCR Clinical Reports](https://arxiv.org/abs/2605.03103)
*Yingyun Li,Yu Wang,Haiyang Qian*
...
### [52] [S^2tory: Story Spine Distillation for Movie Script Summarization](https://arxiv.org/abs/2605.03244)
*Mingzhe Lu,Yanbing Liu,Qihao Wang,Jiarui Zhang,Jiayue Wu,Yue Hu,Yunpeng Li,Yangyan Xu*
...
### [53] [SHIELD: A Diverse Clinical Note Dataset and Distilled Small Language Models for Enterprise-Scale De-identification](https://arxiv.org/abs/2605.03301)
*Jose D. Posada,David Love,Somalee Datta,Priya Desai*
...
### [54] [Detecting Stealth Sycophancy in Mental-Health Dialogue with Dynamic Emotional Signature Graphs](https://arxiv.org/abs/2605.03472)
*Tianze Han,Beining Xu,Hanbo Zhang,Yongming Lu*
...
### [55] [CuraView: A Multi-Agent Framework for Medical Hallucination Detection with GraphRAG-Enhanced Knowledge Verification](https://arxiv.org/abs/2605.03476)
*Severin Ye,Xiao Kong,Xiaopeng He,Guangsu Yan,Dongsuk Oh*
...
### [56] [Revisiting Graph-Tokenizing Large Language Models: A Systematic Evaluation of Graph Token Understanding](https://arxiv.org/abs/2605.03514)
*Zhongjian Zhang,Yue Yu,Mengmei Zhang,Junping Du,Xiao Wang,Chuan Shi*
...
### [57] [PatRe: A Full-Stage Office Action and Rebuttal Generation Benchmark for Patent Examination](https://arxiv.org/abs/2605.03571)
*Qiyao Wang,Xinyi Chen,Longze Chen,Hongbo Wang,Hamid Alinejad-Rokny,Yuan Lin,Min Yang*
...
### [58] [SERE: Structural Example Retrieval for Enhancing LLMs in Event Causality Identification](https://arxiv.org/abs/2605.03701)
*Zhifeng Hao,Zhongjie Chen,Junhao Lu,Shengyin Yu,Guimin Hu,Keli Zhang,Ruichu Cai,Boyan Xu*
...
### [59] [SAM-NER: Semantic Archetype Mediation for Zero-Shot Named Entity Recognition](https://arxiv.org/abs/2605.03706)
*Ruichu Cai,Juntao Gan,Miao Mai,Zhifeng Hao,Boyan Xu*
...
### [60] [Segmenting Human-LLM Co-authored Text via Change Point Detection](https://arxiv.org/abs/2605.03723)
*Mengchu Li,Jin Zhu,Jinglai Li,Chengchun Shi*
...
### [61] [TRACE: A Metrologically-Grounded Engineering Framework for Trustworthy Agentic AI Systems in Operationally Critical Domains](https://arxiv.org/abs/2605.03838)
*Serhii Zabolotnii*
...
### [62] [MCJudgeBench: A Benchmark for Constraint-Level Judge Evaluation in Multi-Constraint Instruction Following](https://arxiv.org/abs/2605.03858)
*Jaeyun Lee,Junyoung Koh,Zeynel Tok,Hunar Batra,Ronald Clark*
...
### [63] [Steer Like the LLM: Activation Steering that Mimics Prompting](https://arxiv.org/abs/2605.03907)
*Geert Heyman,Frederik Vandeputte*
...
### [64] [Atomic Fact-Checking Increases Clinician Trust in Large Language Model Recommendations for Oncology Decision Support: A Randomized Controlled Trial](https://arxiv.org/abs/2605.03916)
*Lisa C. Adams,Linus Marx,Erik Thiele Orberg,Keno Bressem,Sebastian Ziegelmayer,Denise Bernhardt,Markus Graf,Marcus R. Makowski,Stephanie E. Combs,Florian Matthes,Jan C. Peeken*
...
### [65] [The Counterexample Game: Iterated Conceptual Analysis and Repair in Language Models](https://arxiv.org/abs/2605.03936)
*Daniel Drucker,Kyle Mahowald*
...
### [66] [Feature-Augmented Transformers for Robust AI-Text Detection Across Domains and Generators](https://arxiv.org/abs/2605.03969)
*Mohamed Mady,Johannes Reschke,Björn Schuller*
...
### [67] [Safety and accuracy follow different scaling laws in clinical large language models](https://arxiv.org/abs/2605.04039)
*Sebastian Wind,Tri-Thien Nguyen,Jeta Sopa,Mahshad Lotfinia,Sebastian Bickelhaup,Michael Uder,Harald Köstler,Gerhard Wellein,Sven Nebelung,Daniel Truhn,Andreas Maier,Soroosh Tayebi Arasteh*
...
### [68] [When Should a Language Model Trust Itself? Same-Model Self-Verification as a Conditional Confidence Signal](https://arxiv.org/abs/2605.02915)
*Aditya Ajay Phalod*
...
### [70] [Geometric Deviation as an Unsupervised Pre-Generation Reliability Signal: Probing LLM Representations for Answerability](https://arxiv.org/abs/2605.03196)
*Yucheng Du*
...
### [71] [Sparse Memory Finetuning as a Low-Forgetting Alternative to LoRA and Full Finetuning](https://arxiv.org/abs/2605.03229)
*Prakhar Gupta,Garv Shah,Satyam Goyal,Anirudh Kanchi*
...
### [74] [Steer Like the LLM: Activation Steering that Mimics Prompting](https://arxiv.org/abs/2605.03907)
*Geert Heyman,Frederik Vandeputte*
...
### [75] [Safety and accuracy follow different scaling laws in clinical large language models](https://arxiv.org/abs/2605.04039)
*Sebastian Wind,Tri-Thien Nguyen,Jeta Sopa,Mahshad Lotfinia,Sebastian Bickelhaup,Michael Uder,Harald Köstler,Gerhard Wellein,Sven Nebelung,Daniel Truhn,Andreas Maier,Soroosh Tayebi Arasteh*
...
### [76] [CreativityBench: Evaluating Agent Creative Reasoning via Affordance-Based Tool Repurposing](https://arxiv.org/abs/2605.02910)
...
### [77] [Stable Agentic Control: Tool-Mediated LLM Architecture for Autonomous Cyber Defense](https://arxiv.org/abs/2605.03034)
...
### [78] [Computing Thiele Rules on Interval Elections and their Generalizations](https://arxiv.org/abs/2605.03067)
...
### [79] [Making the Invisible Visible: Understanding the Mismatch Between Organizational Goals and Worker Experiences in AI Adoption](https://arxiv.org/abs/2605.03078)
...
### [80] [Programmatic Context Augmentation for LLM-based Symbolic Regression](https://arxiv.org/abs/2605.03101)
...
### [81] [Are you with me? A Framework for Detecting Mental Model Discrepancies in Task-Based Team Dialogues](https://arxiv.org/abs/2605.03149)
...
### [82] [Learning Correct Behavior from Examples: Validating Sequential Execution in Autonomous Agents](https://arxiv.org/abs/2605.03159)
...
### [83] [Terminus-4B: Can a Smaller Model Replace Frontier LLMs at Agentic Execution Tasks?](https://arxiv.org/abs/2605.03195)
...
### [84] [Stop Automating Peer Review Without Rigorous Evaluation](https://arxiv.org/abs/2605.03202)
...
### [85] [ADAPTS: Agentic Decomposition for Automated Protocol-agnostic Tracking of Symptoms](https://arxiv.org/abs/2605.03212)
...
### [86] [Evaluating Prompting and Execution-Based Methods for Deterministic Computation in LLMs](https://arxiv.org/abs/2605.03227)
*Hongkun Yu*
...
### [87] [cotomi Act: Learning to Automate Work by Watching You](https://arxiv.org/abs/2605.03231)
...
### [88] [Enhancing Agent Safety Judgment: Controlled Benchmark Rewriting and Analogical Reasoning for Deceptive Out-of-Distribution Scenarios](https://arxiv.org/abs/2605.03242)
...
### [89] [Revisiting the Travel Planning Capabilities of Large Language Models](https://arxiv.org/abs/2605.03308)
...
### [90] [Automated Large-scale CVRP Solver Design via LLM-assisted Flexible MCTS](https://arxiv.org/abs/2605.03339)
...
### [92] [ReasonAudio: A Benchmark for Evaluating Reasoning Beyond Matching in Text-Audio Retrieval](https://arxiv.org/abs/2605.03361)
...
### [93] [GeoDecider: A Coarse-to-Fine Agentic Workflow for Explainable Lithology Classification](https://arxiv.org/abs/2605.03383)
...
### [94] [Robust Agent Compensation (RAC): Teaching AI Agents to Compensate](https://arxiv.org/abs/2605.03409)
...
### [95] [Geometry over Density: Few-Shot Cross-Domain OOD Detection](https://arxiv.org/abs/2605.03410)
...
### [96] [Adaptive Dual-Path Framework for Covert Semantic Communication](https://arxiv.org/abs/2605.03423)
...
### [105] [MEMTIER: Tiered Memory Architecture and Retrieval Bottleneck Analysis for Long-Running Autonomous AI Agents](https://arxiv.org/abs/2605.03675)
...
### [106] [OracleProto: A Reproducible Framework for Benchmarking LLM Native Forecasting via Knowledge Cutoff and Temporal Masking](https://arxiv.org/abs/2605.03762)
...
### [107] [What You Think is What You See: Driving Exploration in VLM Agents via Visual-Linguistic Curiosity](https://arxiv.org/abs/2605.03782)
...
### [108] [Say the Mission, Execute the Swarm: Agent-Enhanced LLM Reasoning in the Web-of-Drones](https://arxiv.org/abs/2605.03788)
...
### [109] [ScrapMem: A Bio-inspired Framework for On-device Personalized Agent Memory via Optical Forgetting](https://arxiv.org/abs/2605.03804)
...
### [110] [Agentic-imodels: Evolving agentic interpretability tools via autoresearch](https://arxiv.org/abs/2605.03808)
...
### [111] [SOAR: Real-Time Joint Optimization of Order Allocation and Robot Scheduling in Robotic Mobile Fulfillment Systems](https://arxiv.org/abs/2605.03842)
...
### [112] [Mechanical Conscience: A Mathematical Framework for Dependability of Machine Intelligenc](https://arxiv.org/abs/2605.03847)
...
### [113] [Correct Is Not Enough: Training Reasoning Planners with Executor-Grounded Rewards](https://arxiv.org/abs/2605.03862)
...
### [114] [Quantifying the human visual exposome with vision language models](https://arxiv.org/abs/2605.03863)
...
### [115] [EvoLM: Self-Evolving Language Models through Co-Evolved Discriminative Rubrics](https://arxiv.org/abs/2605.03871)
...
### [123] [CreativityBench: Evaluating Agent Creative Reasoning via Affordance-Based Tool Repurposing](https://arxiv.org/abs/2605.02910)
*Cheng Qian,Hyeonjeong Ha,Jiayu Liu,Bingxiang He,Jeonghwan Kim,Jiateng Liu,Bingxuan Li,Aditi Tiwari,Dwip Dalal,Zhenhailong Wang,Xiusi Chen,Mahdi Namazifar,Yunzhu Li,Heng Ji*
...
### [127] [Correct Is Not Enough: Training Reasoning Planners with Executor-Grounded Rewards](https://arxiv.org/abs/2605.03862)
*Tianyang Han,Hengyu Shi,Junjie Hu,Xu Yang,Zhiling Wang,Junhao Su*
...
### [128] [OpenSeeker-v2: Pushing the Limits of Search Agents with Informative and High-Difficulty Trajectories](https://arxiv.org/abs/2605.04036)
*Yuwen Du,Rui Ye,Shuo Tang,Keduan Huang,Xinyu Zhu,Yuzhu Cai,Siheng Chen*
...
### [129] [An Information-Geometric Framework for Stability Analysis of Large Language Models under Entropic Stress](https://arxiv.org/abs/2604.24076)
...
### [131] [CreativityBench: Evaluating Agent Creative Reasoning via Affordance-Based Tool Repurposing](https://arxiv.org/abs/2605.02910)
*Cheng Qian,Hyeonjeong Ha,Jiayu Liu,Bingxiang He,Jeonghwan Kim,Jiateng Liu,Bingxuan Li,Aditi Tiwari,Dwip Dalal,Zhenhailong Wang,Xiusi Chen,Mahdi Namazifar,Yunzhu Li,Heng Ji*
...
### [135] [Agentic-imodels: Evolving agentic interpretability tools via autoresearch](https://arxiv.org/abs/2605.03808)
*Chandan Singh,Yan Shuo Tan,Weijia Xu,Zelalem Gero,Weiwei Yang,Michel Galley,Jianfeng Gao*
...
### [136] [StateSMix: Online Lossless Compression via Mamba State Space Models and Sparse N-gram Context Mixing](https://arxiv.org/abs/2605.02904)
*Roberto Tacconelli*
...
### [137] [eOptShrinkQ: Near-Lossless KV Cache Compression Through Optimal Spectral Denoising and Quantization](https://arxiv.org/abs/2605.02905)
*Pei-Chun Su*
...
### [138] [An End-to-End Framework for Building Large Language Models for Software Operations](https://arxiv.org/abs/2605.02906)
...
### [139] [On the Invariants of Softmax Attention](https://arxiv.org/abs/2605.02907)
*Wonsuk Lee*
...
### [140] [Delay, Plateau, or Collapse: Evaluating the Impact of Systematic Verification Error on RLVR](https://arxiv.org/abs/2605.02909)
...
### [141] [Agentic AI-Based Joint Computing and Networking via Mixture of Experts and Large Language Models](https://arxiv.org/abs/2605.02911)
...
### [142] [Generate, Filter, Control, Replay: A Comprehensive Survey of Rollout Strategies for LLM Reinforcement Learning](https://arxiv.org/abs/2605.02913)
...
### [143] [When Safety Geometry Collapses: Fine-Tuning Vulnerabilities in Agentic Guard Models](https://arxiv.org/abs/2605.02914)
...
### [144] [From Synthesis to Clinical Assistance: A Strategy-Aware Agent Framework for Autism Intervention based on Real Clinical Dataset](https://arxiv.org/abs/2605.02916)
...
### [145] [PRISM-CTG: A Foundation Model for Cardiotocography Analysis with Multi-View SSL](https://arxiv.org/abs/2605.02917)
...
### [146] [Mitigating the reconstruction-detection trade-off in VAE-based unsupervised anomaly detection](https://arxiv.org/abs/2605.02918)
...
### [147] [Heterogeneous Graph Importance Scoring and Clustering with Automated LLM-based Interpretation](https://arxiv.org/abs/2605.02919)
*Takato Yasuno*
...
### [148] [DeRelayL: Sustainable Decentralized Relay Learning](https://arxiv.org/abs/2605.02935)
...
### [149] [Proteo-R1: Reasoning Foundation Models for De Novo Protein Design](https://arxiv.org/abs/2605.02937)
...
### [150] [PAMNet: Cycle-aware Phase-Amplitude Modulation Network for Multivariate Time Series Forecasting](https://arxiv.org/abs/2605.02938)
...
### [151] [From Static Analysis to Audience Dissemination: A Training-Free Multimodal Controversy Detection Multi-Agent Framework](https://arxiv.org/abs/2605.02939)
...
### [152] [PrismAgent: Illuminating Harm in Memes via a Zero-Shot Interpretable Multi-Agent Framework](https://arxiv.org/abs/2605.02940)
*Zihan Ding,Ziyuan Yang,Yi Zhang*
...
### [153] [A Framework for Exploring and Disentangling Intersectional Bias: A Case Study in Fetal Ultrasound](https://arxiv.org/abs/2605.02942)
...
### [154] [Healthcare AI GYM for Medical Agents](https://arxiv.org/abs/2605.02943)
*Minbyul Jeong*
...
### [155] [Exploring Pass-Rate Reward in Reinforcement Learning for Code Generation](https://arxiv.org/abs/2605.02944)
...
### [156] [RouteHijack: Routing-Aware Attack on Mixture-of-Experts LLMs](https://arxiv.org/abs/2605.02946)
...
### [159] [Disease Is a Spectral Perturbation](https://arxiv.org/abs/2605.02949)
...
### [160] [Kernel Affine Hull Machines for Compute-Efficient Query-Side Semantic Encoding](https://arxiv.org/abs/2605.02950)
...
### [161] [Calibration of the underlying surface parameters for urban flood using latent variables and adjoint equation](https://arxiv.org/abs/2605.02959)
...
### [162] [ZeRO-Prefill: Zero Redundancy Overheads in MoE Prefill Serving](https://arxiv.org/abs/2605.02960)
...
### [163] [Analytic Bridge Diffusions for Controlled Path Generation](https://arxiv.org/abs/2605.02961)
*Michael Chertkov*
...
### [165] [Reward Hacking Benchmark: Measuring Exploits in LLM Agents with Tool Use](https://arxiv.org/abs/2605.02964)
*Kunvar Thaman*
...
### [166] [Joint Energy Management and Coordinated AIGC Workload Scheduling for Distributed Data Centers: A Diffusion-Aided Reward Shaping Approach](https://arxiv.org/abs/2605.02965)
...
### [167] [AutoRAGTuner: A Declarative Framework for Automatic Optimization of RAG Pipelines](https://arxiv.org/abs/2605.02967)
...
### [168] [Finite-Size Gradient Transport in Large Language Model Pretraining: From Cascade Size to Intensive Transport Efficiency](https://arxiv.org/abs/2605.02968)
*Ping Wang,Yan-Qi Du*
...
### [169] [Multilingual Safety Alignment via Self-Distillation](https://arxiv.org/abs/2605.02971)
...
### [170] [Structured Diffusion Bridges: Inductive Bias for Denoising Diffusion Bridges](https://arxiv.org/abs/2605.02973)
...
### [171] [Mixed-Precision Information Bottlenecks for On-Device Trait-State Disentanglement in Bipolar Agitation Detection](https://arxiv.org/abs/2605.03039)
*Joydeep Chandra*
...
### [172] [TCD-Arena: Assessing Robustness of Time Series Causal Discovery Methods Against Assumption Violations](https://arxiv.org/abs/2605.03045)
...
### [173] [Neuron-Anchored Rule Extraction for Large Language Models via Contrastive Hierarchical Ablation](https://arxiv.org/abs/2605.03058)
...
### [174] [OGPO: Sample Efficient Full-Finetuning of Generative Control Policies](https://arxiv.org/abs/2605.03065)
...
### [175] [Adaptive Negative Scheduling for Graph Contrastive Learning](https://arxiv.org/abs/2605.03076)
...
### [176] [Adaptive Data Compression and Reconstruction for Memory-Bounded EEG Continual Learning](https://arxiv.org/abs/2605.03085)
*Chengcheng Xie*
...
### [177] [Attribution-Guided Masking for Robust Cross-Domain Sentiment Classification](https://arxiv.org/abs/2605.03091)
...
### [178] [When Prompts Interact: Assessing Prompt Arithmetic for Deconfounding under Distribution Shift](https://arxiv.org/abs/2605.03096)
...
### [179] [Pose Tracking with a Foundation Pose Model and an Ensemble Directional Kalman Filter](https://arxiv.org/abs/2605.03105)
...
### [180] [Gated Subspace Inference for Transformer Acceleration](https://arxiv.org/abs/2605.03109)
*Stephen J. Thomas*
...
### [181] [Cascade Token Selection for Transformer Attention Acceleration](https://arxiv.org/abs/2605.03110)
*Stephen J. Thomas*
...
### [182] [Taming the Curses of Multiagency in Robust Markov Games with Large State Space through Linear Function Approximation](https://arxiv.org/abs/2605.03125)
...
### [183] [On the Invariants of Softmax Attention](https://arxiv.org/abs/2605.02907)
*Wonsuk Lee*
...
### [184] [Instance-Level Costs for Nuanced Classifier Evaluation](https://arxiv.org/abs/2605.03135)
...
### [185] [AutoRAGTuner: A Declarative Framework for Automatic Optimization of RAG Pipelines](https://arxiv.org/abs/2605.02967)
*Xintan Zeng,Yongchao Liu,Yice Luo,Jiajun Zhen*
...
### [186] [Delay, Plateau, or Collapse: Evaluating the Impact of Systematic Verification Error on RLVR](https://arxiv.org/abs/2605.02909)
*Kazuki Egashira,Mark Vero,Jasper Dekoninck,Florian E. Dorner,Robin Staab,Martin Vechev*
...
### [187] [OCRR: A Benchmark for Online Correction Recovery under Distribution Shift](https://arxiv.org/abs/2605.03153)
*Adrian Grassi*
...
### [188] [Multilingual Safety Alignment via Self-Distillation](https://arxiv.org/abs/2605.02971)
*Ruiyang Qin,Qingzhuo Wang,Dongrui Liu,Qiang Li,Zhihua Wei,Wen Shen*
...
### [189] [When Safety Geometry Collapses: Fine-Tuning Vulnerabilities in Agentic Guard Models](https://arxiv.org/abs/2605.02914)
*Ismail Hossain,Sai Puppala,Jannatul Ferdaus,Md Jahangir Alam,Yoonpyo Lee,Syed Bahauddin Alam,Sajedul Talukder*
...
### [191] [When Prompts Interact: Assessing Prompt Arithmetic for Deconfounding under Distribution Shift](https://arxiv.org/abs/2605.03096)
*Zhecheng Sheng,Yongsen Tan,Xiruo Ding,Trevor Cohen,Serguei Pakhomov*
...
### [192] [PRISM-CTG: A Foundation Model for Cardiotocography Analysis with Multi-View SSL](https://arxiv.org/abs/2605.02917)
*Sheng Wong,Ravi Shankar,Beth Albert,Hao Fei,Lin Li,Imane Ben M'Barek,Manu Vatish,Gabriel Davis Jones*
...
### [195] [Mitigating the reconstruction-detection trade-off in VAE-based unsupervised anomaly detection](https://arxiv.org/abs/2605.02918)
*Agathe Senellart,Maëlys Solal,Stéphanie Allassonnière,Ninon Burgos*
...
### [198] [Moral Sensitivity in LLMs: A Tiered Evaluation of Contextual Bias via Behavioral Profiling and Mechanistic Interpretability](https://arxiv.org/abs/2605.03217)
...
### [199] [The Right Answer, the Wrong Direction: Why Transformers Fail at Counting and How to Fix It](https://arxiv.org/abs/2605.03258)
*Gabriel Garcia*
...
### [200] [Proteo-R1: Reasoning Foundation Models for De Novo Protein Design](https://arxiv.org/abs/2605.02937)
*Fang Wu,Weihao Xuan,Heli Qi,Hanqun Cao,Heng-Jui Chang,Zeqi Zhou,Haokai Zhao,Ma Jian,Carl Ma,Yu-Chi Cheng,Kuan Pang,Xiangru Tang,Zehong Wang,Guanlue Li,Hanchen Wang,Kejun Ying,Pan Lu,Chiho Im,Seungju Han,Peng Xia,Tinson Xu,Yinxi Li,Deyao Zhu,Pheng-Ann Heng,Naoto Yokoya,Masashi Sugiyama,Li Erran Li,Jure Leskovec,Yejin Choi*
...
### [201] [Beyond Activation Alignment: The Geometry of Neural Sensitivity](https://arxiv.org/abs/2605.03222)
...
### [203] [PAMNet: Cycle-aware Phase-Amplitude Modulation Network for Multivariate Time Series Forecasting](https://arxiv.org/abs/2605.02938)
*Yingbo Zhou,Yutong Ye,Zhiwei Ling,Shuhao Li,Rui Qian,Jian Xiong,Li Sun,Dejing Dou*
...
### [204] [Self-Mined Hardness for Safety Fine-Tuning](https://arxiv.org/abs/2605.03226)
...
### [205] [From Static Analysis to Audience Dissemination: A Training-Free Multimodal Controversy Detection Multi-Agent Framework](https://arxiv.org/abs/2605.02939)
*Zihan Ding,Ziyuan Yang,Yi Zhang*
...
### [207] [Task Vector Geometry Underlies Dual Modes of Task Inference in Transformers](https://arxiv.org/abs/2605.03780)
...
### [208] [PrismAgent: Illuminating Harm in Memes via a Zero-Shot Interpretable Multi-Agent Framework](https://arxiv.org/abs/2605.02940)
*Zihan Ding,Ziyuan Yang,Yi Zhang*
...
### [209] [Posterior-First Neural PDE Simulation: Inferring Hidden Problem State from a Single Field](https://arxiv.org/abs/2605.03247)
...
### [210] [Healthcare AI GYM for Medical Agents](https://arxiv.org/abs/2605.02943)
*Minbyul Jeong*
...
### [211] [Ortho-Hydra: Orthogonalized Experts for DiT LoRA](https://arxiv.org/abs/2605.03252)
*Seunghyun Ji*
...
### [212] [Exploring Pass-Rate Reward in Reinforcement Learning for Code Generation](https://arxiv.org/abs/2605.02944)
*Xin-Ye Li,Ren-Biao Liu,Yun-Ji Zhang,Hui Sun,Zheng Xie,Ming Li*
...
### [213] [Do LLMs have core beliefs?](https://arxiv.org/abs/2605.03255)
...
### [214] [Transformers with Selective Access to Early Representations](https://arxiv.org/abs/2605.03953)
...
### [215] [RouteHijack: Routing-Aware Attack on Mixture-of-Experts LLMs](https://arxiv.org/abs/2605.02946)
*Zhiyuan Xu,Joseph Gardiner,Sana Belguith,Lichao Wu*
...
### [216] [The Right Answer, the Wrong Direction: Why Transformers Fail at Counting and How to Fix It](https://arxiv.org/abs/2605.03258)
*Gabriel Garcia*
...
### [217] [Predicting Euler Characteristics and Constructing Topological Structure Using Machine Learning Techniques](https://arxiv.org/abs/2605.02947)
*Gyunghun Yu,Seong Min Park,Han Gyu Yoon,Tae Jung Moon,Jun Woo Choi,Hee Young Kwon,Changyeon Won*
...
### [218] [A Universal Reproducing Kernel Hilbert Space from Polynomial Alignment and IMQ Distance](https://arxiv.org/abs/2605.03262)
*Taha Bouhsine*
...
### [219] [AsymK-Talker: Real-Time and Long-Horizon Talking Head Generation via Asymmetric Kernel Distillation](https://arxiv.org/abs/2605.02948)
*Yuxin Lu,Qian Qiao,Jiayang Sun,Min Cao,Guibo Zhu*
...
### [220] [Partially Observed Structural Causal Models](https://arxiv.org/abs/2605.03268)
...
### [221] [Kernel Affine Hull Machines for Compute-Efficient Query-Side Semantic Encoding](https://arxiv.org/abs/2605.02950)
*Mohit Kumar,Somayeh Kargaran,Bernhard A. Moser,Manuela Geiß*
...
### [222] [RFPrompt: Prompt-Based Expert Adaptation of the Large Wireless Model for Modulation Classification](https://arxiv.org/abs/2605.03279)
...
### [223] [Analytic Bridge Diffusions for Controlled Path Generation](https://arxiv.org/abs/2605.02961)
*Michael Chertkov*
...
### [225] [Reward Hacking Benchmark: Measuring Exploits in LLM Agents with Tool Use](https://arxiv.org/abs/2605.02964)
*Kunvar Thaman*
...
### [227] [AutoRAGTuner: A Declarative Framework for Automatic Optimization of RAG Pipelines](https://arxiv.org/abs/2605.02967)
*Xintan Zeng,Yongchao Liu,Yice Luo,Jiajun Zhen*
...
### [228] [Distributed Learning with Adversarial Gradient Perturbations](https://arxiv.org/abs/2605.03313)
...
### [229] [Finite-Size Gradient Transport in Large Language Model Pretraining: From Cascade Size to Intensive Transport Efficiency](https://arxiv.org/abs/2605.02968)
*Ping Wang,Yan-Qi Du*
...
### [230] [DGPO: Distribution Guided Policy Optimization for Fine Grained Credit Assignment](https://arxiv.org/abs/2605.03327)
...
### [232] [LLM-ADAM: A Generalizable LLM Agent Framework for Pre-Print Anomaly Detection in Additive Manufacturing](https://arxiv.org/abs/2605.03328)
...
### [233] [Structured Diffusion Bridges: Inductive Bias for Denoising Diffusion Bridges](https://arxiv.org/abs/2605.02973)
*Eitan Kosman,Gabriele Serussi,Chaim Basking*
...
### [235] [Mixed-Precision Information Bottlenecks for On-Device Trait-State Disentanglement in Bipolar Agitation Detection](https://arxiv.org/abs/2605.03039)
*Joydeep Chandra*
...
### [236] [Population-Aware Imitation Learning in Mean-field Games with Common Noise](https://arxiv.org/abs/2605.03357)
...
### [237] [Neuron-Anchored Rule Extraction for Large Language Models via Contrastive Hierarchical Ablation](https://arxiv.org/abs/2605.03058)
*Francesco Sovrano,Gabriele Dominici,Marc Langheinrich*
...
### [238] [Fully Automatic Trace Gas Plume Detection](https://arxiv.org/abs/2605.03372)
...
### [239] [Learning Dynamics of Zeroth-Order Optimization: A Kernel Perspective](https://arxiv.org/abs/2605.03373)
...
### [240] [Gated Subspace Inference for Transformer Acceleration](https://arxiv.org/abs/2605.03109)
*Stephen J. Thomas*
...
### [241] [GRAFT: Auditing Graph Neural Networks via Global Feature Attribution](https://arxiv.org/abs/2605.03377)
...
### [242] [Cascade Token Selection for Transformer Attention Acceleration](https://arxiv.org/abs/2605.03110)
*Stephen J. Thomas*
...
### [243] [Two Calls, Two Moments, and the Vote-Accuracy Curve of Repeated LLM Inference](https://arxiv.org/abs/2605.03379)
*Yi Liu*
...
### [244] [Global and Local Topology-Aware Attention with Persistent Homology and Euler Biases for Time-Series Forecasting](https://arxiv.org/abs/2605.03163)
*Usef Faghihi,Amir Saki*
...
### [245] [Local Truncation Error-Guided Neural ODEs for Large Scale Traffic Forecasting](https://arxiv.org/abs/2605.03386)
...
### [246] [Self-Mined Hardness for Safety Fine-Tuning](https://arxiv.org/abs/2605.03226)
*Prakhar Gupta,Garv Shah,Donghua Zhang*
...
### [247] [Graph Reconstruction from Differentially Private GNN Explanations](https://arxiv.org/abs/2605.03388)
...
### [248] [PODiff: Latent Diffusion in Proper Orthogonal Decomposition Space for Scientific Super-Resolution](https://arxiv.org/abs/2605.03399)
...
### [249] [Posterior-First Neural PDE Simulation: Inferring Hidden Problem State from a Single Field](https://arxiv.org/abs/2605.03247)
*Wenshuo Wang,Fan Zhang*
...
### [250] [Discovering Reinforcement Learning Interfaces with Large Language Models](https://arxiv.org/abs/2605.03408)
...
### [251] [Ortho-Hydra: Orthogonalized Experts for DiT LoRA](https://arxiv.org/abs/2605.03252)
*Seunghyun Ji*
...
### [252] [Learning to Theorize the World from Observation](https://arxiv.org/abs/2605.03413)
...
### [253] [Partially Observed Structural Causal Models](https://arxiv.org/abs/2605.03268)
*Turan Orujlu,Jordan Matelsky,Martin V. Butz,Charley M. Wu,Konrad P. Kording*
...
### [254] [FIBER: A Differentially Private Optimizer with Filter-Aware Innovation Bias Correction](https://arxiv.org/abs/2605.03425)
...
### [255] [DynaTab: Dynamic Feature Ordering as Neural Rewiring for High-Dimensional Tabular Data](https://arxiv.org/abs/2605.03430)
...
### [256] [DGPO: Distribution Guided Policy Optimization for Fine Grained Credit Assignment](https://arxiv.org/abs/2605.03327)
*Hongbo Jin,Rongpeng Zhu,Zhongjing Du,Xu Jiang,Jingqi Tian,Qiaoman Zhang,Jiayu Ding*
...
### [257] [Quantum Hierarchical Reinforcement Learning via Variational Quantum Circuits](https://arxiv.org/abs/2605.03434)
...
### [258] [LLM-ADAM: A Generalizable LLM Agent Framework for Pre-Print Anomaly Detection in Additive Manufacturing](https://arxiv.org/abs/2605.03328)
*Ahmadreza Eslaminia,Chuhan Cai,Cameron Smith,Ruo-Syuan Mei,Shichen Li,Rajiv Malhotra,Klara Nahrstedt,Chenhui Shao*
...
### [259] [Learning Generalizable Action Representations via Pre-training AEMG](https://arxiv.org/abs/2605.03462)
...
### [260] [Toward Structural Multimodal Representations: Specialization, Selection, and Sparsification via Mixture-of-Experts](https://arxiv.org/abs/2605.03348)
*Hahyeon Choi,Nojun Kwak*
...
### [261] [Bandits on graphs and structures](https://arxiv.org/abs/2605.03493)
*Michal Valko*
...
### [262] [Local Truncation Error-Guided Neural ODEs for Large Scale Traffic Forecasting](https://arxiv.org/abs/2605.03386)
*Xiao Zhang,Yafei Li,Ruixiang Wang,Wei Wei,Shuo He,Mingliang Xu*
...
### [263] [Adaptive graph-based algorithms for conditional anomaly detection and semi-supervised learning](https://arxiv.org/abs/2605.03495)
*Michal Valko*
...
### [264] [Discovering Reinforcement Learning Interfaces with Large Language Models](https://arxiv.org/abs/2605.03408)
*Akshat Singh Jaswal,Ashish Baghel,Paras Chopra*
...
### [265] [Bandits attack function optimization](https://arxiv.org/abs/2605.03496)
...
### [266] [Learning to Theorize the World from Observation](https://arxiv.org/abs/2605.03413)
*Doojin Baek,Gyubin Lee,Junyeob Baek,Hosung Lee,Sungjin Ahn*
...
### [267] [GRIFDIR: Graph Resolution-Invariant FEM Diffusion Models in Function Spaces over Irregular Domains](https://arxiv.org/abs/2605.03497)
...
### [268] [DynaTab: Dynamic Feature Ordering as Neural Rewiring for High-Dimensional Tabular Data](https://arxiv.org/abs/2605.03430)
*Al Zadid Sultan Bin Habib,Gianfranco Doretto,Donald A. Adjeroh*
...
### [269] [A Hierarchical Sampling Framework for bounding the Generalization Error of Federated Learning](https://arxiv.org/abs/2605.03499)
...
### [270] [Learning Generalizable Action Representations via Pre-training AEMG](https://arxiv.org/abs/2605.03462)
*Zhenghao Huang,Huilin Yao,Kaikai Wang,Lin Shu*
...
### [271] [Meta-Inverse Physics-Informed Neural Networks for High-Dimensional Ordinary Differential Equations](https://arxiv.org/abs/2605.03511)
...
### [272] [Understanding Self-Supervised Learning via Latent Distribution Matching](https://arxiv.org/abs/2605.03517)
...
### [273] [PerFlow: Physics-Embedded Rectified Flow for Efficient Reconstruction and Uncertainty Quantification of Spatiotemporal Dynamics](https://arxiv.org/abs/2605.03548)
...
### [274] [Meta-Inverse Physics-Informed Neural Networks for High-Dimensional Ordinary Differential Equations](https://arxiv.org/abs/2605.03511)
*Zhao Wei,Kenneth Hor Cheng Koh,Sheng Yuan Chin,James Chun Yip Chan,Chin Chun Ooi,Yew-Soon Ong*
...
### [275] [Enhance the after-discharge mortality rate prediction via learning from the medical notes](https://arxiv.org/abs/2605.03560)
*Zijiang Yang*
...
### [276] [HeadQ: Model-Visible Distortion and Score-Space Correction for KV-Cache Quantization](https://arxiv.org/abs/2605.03562)
...
### [278] [Disentangling Shared and Task-Specific Representations from Multi-Modal Clinical Data](https://arxiv.org/abs/2605.03570)
...
### [281] [Disentangling Shared and Task-Specific Representations from Multi-Modal Clinical Data](https://arxiv.org/abs/2605.03570)
*He Lyu,Huolin Zeng,Junren Wang,Huazhen Yang,Linchao He,Yong Chen,Zhirui Li,Andreas Maier,Siming Bayer,Huan Song*
...
### [284] [Flow Matching on Symmetric Spaces](https://arxiv.org/abs/2605.03588)
*Francesco Ruscelli,Ferdinando Zanchetta,Rita Fioresi*
...
### [285] [Information Plane Analysis of Binary Neural Networks](https://arxiv.org/abs/2605.03636)
...
### [286] [ELAS: Efficient Pre-Training of Low-Rank Large Language Models via 2:4 Activation Sparsity](https://arxiv.org/abs/2605.03667)
...
### [287] [ELAS: Efficient Pre-Training of Low-Rank Large Language Models via 2:4 Activation Sparsity](https://arxiv.org/abs/2605.03667)
*Jiaxi Li,Lu Yin,Li Shen,Jinjin Xu,Yuhui Liu,Wenwu Wang,Shiwei Liu,Xilu Wang*
...
### [288] [Graph Neural Network based Hierarchy-Aware Embeddings of Knowledge Graphs: Applications to Yeast Phenotype Prediction](https://arxiv.org/abs/2605.03690)
...
### [289] [Uni-OPD: Unifying On-Policy Distillation with a Dual-Perspective Recipe](https://arxiv.org/abs/2605.03677)
...
### [290] [From Code to Prediction: Fine-Tuning LLMs for Neural Network Performance Classification in NNGPT](https://arxiv.org/abs/2605.03686)
...
### [291] [Graph Neural Network based Hierarchy-Aware Embeddings of Knowledge Graphs: Applications to Yeast Phenotype Prediction](https://arxiv.org/abs/2605.03690)
*Filip Kronström,Alexander H. Gower,Daniel Brunnsåker,Ievgeniia A. Tiukova,Ross D. King*
...
### [292] [Distribution-Free Pretraining of Classification Losses via Evolutionary Dynamics](https://arxiv.org/abs/2605.03722)
*Meng Xiang,Yan Pei*
...
### [293] [Rethinking the Rank Threshold for LoRA Fine-Tuning](https://arxiv.org/abs/2605.03724)
*Juneyoung Park*
...
### [294] [Rethinking the Rank Threshold for LoRA Fine-Tuning](https://arxiv.org/abs/2605.03724)
*Juneyoung Park*
...
### [295] [GEM-FI: Gated Evidential Mixtures with Fisher Modulation](https://arxiv.org/abs/2605.03750)
...
### [296] [Vanishing L2 regularization for the softmax Multi Armed Bandit](https://arxiv.org/abs/2605.03752)
...
### [297] [Spatiotemporal Convolutions on EEG signal -- A Representation Learning Perspective on Efficient and Explainable EEG Classification with Convolutional Neural Nets](https://arxiv.org/abs/2605.03874)
...
### [298] [Nora: Normalized Orthogonal Row Alignment for Scalable Matrix Optimizer](https://arxiv.org/abs/2605.03769)
...
### [299] [Task Vector Geometry Underlies Dual Modes of Task Inference in Transformers](https://arxiv.org/abs/2605.03780)
*Hao Yan,Haolin Yang,Yiqiao Zhong*
...
### [300] [Graph Convolutional Support Vector Regression for Robust Spatiotemporal Forecasting of Urban Air Pollution](https://arxiv.org/abs/2605.03795)
...
### [301] [Realizable Bayes-Consistency for General Metric Losses](https://arxiv.org/abs/2605.03823)
...
### [303] [A Domain Incremental Continual Learning Benchmark for ICU Time Series Model Transportability](https://arxiv.org/abs/2605.03832)
...
### [304] [Complex Equation Learner: Rational Symbolic Regression with Gradient Descent in Complex Domain](https://arxiv.org/abs/2605.03841)
...
### [306] [Memory-Efficient Continual Learning with CLIP Models](https://arxiv.org/abs/2605.03866)
...
### [307] [On Adaptivity in Zeroth-Order Optimization](https://arxiv.org/abs/2605.03869)
...
### [308] [Spatiotemporal Convolutions on EEG signal -- A Representation Learning Perspective on Efficient and Explainable EEG Classification with Convolutional Neural Nets](https://arxiv.org/abs/2605.03874)
*Laurits Dixen,Stefan Heinrich,Paolo Burelli*
...
### [309] [From Data Lifting to Continuous Risk Estimation: A Process-Aware Pipeline for Predictive Monitoring of Clinical Pathways](https://arxiv.org/abs/2605.03895)
...
### [310] [Optimal Posterior Sampling for Policy Identification in Tabular Markov Decision Processes](https://arxiv.org/abs/2605.03921)
...
### [311] [TabSurv: Adapting Modern Tabular Neural Networks to Survival Analysis](https://arxiv.org/abs/2605.03944)
*Stanislav Kirpichenko,Andrei Konstantinov,Lev Utkin*
...
### [312] [Integrating Feature Correlation in Differential Privacy with Applications in DP-ERM](https://arxiv.org/abs/2605.03945)
...
### [313] [Transformers with Selective Access to Early Representations](https://arxiv.org/abs/2605.03953)
*Skye Gunasekaran,Téa Wright,Rui-Jie Zhu,Jason Eshraghian*
...
### [314] [Pretrained Model Representations as Acquisition Signals for Active Learning of MLIPs](https://arxiv.org/abs/2605.03964)
...
### [315] [Flow Sampling: Learning to Sample from Unnormalized Densities via Denoising Conditional Processes](https://arxiv.org/abs/2605.03984)
*Aaron Havens,Brian Karrer,Neta Shaul*
...
### [316] [A Closed-Form Adaptive-Landmark Kernel for Certified Point-Cloud and Graph Classification](https://arxiv.org/abs/2605.04046)
