...
### [34] [BCMT: Blockwise Causal Memory Transformer](https://arxiv.org/abs/2608.13578)
*Rachid Arezki*
...
### [36] [GALA: Generation-Aware Cross-Modal Alignment for Text-to-Time-Series Synthesis](https://arxiv.org/abs/2608.13741)
*Haochen Zhang,Gengwei Zhang,Laura Yao,Nicholas Knoz,Tianlong Chen*
...
### [37] [Amplified Does Not Mean Predictive: Reasoning Behaviors in Thinking Models](https://arxiv.org/abs/2608.13760)
*Jean de Dieu Nyandwi,Leena Mathur,Yonatan Bisk,Robert Hawkins,Graham Neubig*
...
### [38] [Does a Language Server Save Tokens for Coding Agents? A Measurement Methodology and Preliminary Study](https://arxiv.org/abs/2608.13568)
*Pengcheng Xu*
...
### [39] [Think in Latent, Explain in Language: Self-Explainable Latent Reasoning](https://arxiv.org/abs/2608.13570)
*Dayuan Zhao,Shengcao Cao,Yu-Xiong Wang,Liang-Yan Gui*
...
### [40] [Not All Tokens Are Equal: Inflation-Aware Routing for Agentic LLM Systems](https://arxiv.org/abs/2608.13571)
*Heming Fu,Shan Lin,Qianqian Xie,Guojun Xiong*
...
### [41] [BCMT: Blockwise Causal Memory Transformer](https://arxiv.org/abs/2608.13578)
*Rachid Arezki*
...
### [42] [Jais 2: A Family of Arabic-Centric Open Large Language Models](https://arxiv.org/abs/2608.13580)
*Mohamed Anwar,Abed Alhakim Freihat,George Ibrahim,Mostafa Awad,Abdelrahman Sadallah,Gurpreet Gosal,Gokulakrishnan Ramakrishnan,Sarath Chandran,Biswajit Mishra,Rituraj Joshi,Ahmed Frikha,Etienne Goffinet,Abhishek Maiti,Ali El Filali,Sarah AlBarri,Samujjwal Ghosh,Rahul Pal,Parvez Mullah,Awantika Shukla,Sajid siddiki,Samta Kamboj,Onkar Pandit,Sunil Kumar Sahu,AbdelRahman Elbadawy,Amr Mohamed,Ahmad Chamma,Evan Dufraisse,Abdelaziz Bounhar,Dani Bouch,Hadi Abdine,Guokan Shang,Fajri Koto,Yuxia Wang,Zhuohan Xie,Ali Mekky,Rania Elbadry,Sarfraz Ahmad,Momina Ahsan,Omar El Herraoui,Daniil Orel,Hasan Iqbal,Kareem Elzeky,Mervat Abassy,Kareem Elozeiri,Saadeldine Eletter,Farah Atif,Nurdaulet Mukhituly,Haonan Li,Xudong Han,Aaryamonvikram Singh,Zainul Abedien Ahmed Quraishi,Neha Sengupta,Larry Murray,Avraham Sheinin,Joel Hestness,Natalia Vassilieva,Hector Xuguang Ren,Zhengzhong Liu,Michalis Vazirgiannis,Preslav Nakov*
...
### [43] [IterCOMP: Reasoning-aware Adaptive Prompt Compression for Multi-hop Question Answering](https://arxiv.org/abs/2608.13588)
*JungMin Yun,YoungBin Kim*
...
### [44] [You Only Pass Once: Answering and Abstaining Together in a Single Forward Pass of a Frozen Language Model](https://arxiv.org/abs/2608.14465)
*Ziyang Luo,Zhongyao Chu,Xinjie He,Youting Wang,Xukui Qin,Runxiong Wu,Yan-Syuan Chen*
...
### [45] [Measuring Fairness in Large Audio Language Models via Semantic-Aware Bias Estimation](https://arxiv.org/abs/2608.13624)
*Zhe Liu*
...
### [46] [CLAIR-Fin: An Adversarial Multi-Agent Framework for Claim-Level Verification and Adaptive Debate in Cross-Modal Financial QA](https://arxiv.org/abs/2608.13706)
*Fatema Tuj Johora Faria,Mukaffi Bin Moin,Jubayer Al Mahmud,M. F. Mridha,Md. Alam Hossain*
...
### [47] [TeachMateGPT: A Multi-Agent Knowledge-Grounded Framework for Pedagogical Assessment Generation from Science Curriculum Materials](https://arxiv.org/abs/2608.13708)
*Fatema Tuj Johora Faria,Mukaffi Bin Moin,M. F. Mridha,Jubayer Al Mahmud*
...
### [48] [Amplified Does Not Mean Predictive: Reasoning Behaviors in Thinking Models](https://arxiv.org/abs/2608.13760)
*Jean de Dieu Nyandwi,Leena Mathur,Yonatan Bisk,Robert Hawkins,Graham Neubig*
...
### [49] [ASSERT: A Measurement Pipeline for GenAI Audits](https://arxiv.org/abs/2608.13840)
*Riccardo Fogliato,Abhinav Palia,Xiawei Wang,Emily Sheng,Chad Atalla,Jean Garcia-Gathright,Nicholas Pangakis,Sharman Tan,Dan Vann,Hannah Washington,P. Alex Dow,Heba Elfardy,Hanna Wallach,Sandeep Atluri*
...
### [50] [How Much Do Legal RAG Systems Still Hallucinate?](https://arxiv.org/abs/2608.14210)
*Souvick Das,Sallam Abualhaija,Domenico Bianculli*
...
### [51] [SimpleOPD: Simple Tokenizer-Agnostic On-Policy Distillation for Long-Context Reasoning](https://arxiv.org/abs/2608.14277)
*Haonan He,Haodi Lei,Yun Luo,Haoran Zhang,Shunkai Zhang,Yizhuo Li,Shengji Tang,Zhilin Wang,Runzhe Zhan,Lei Bai,Ganqu Cui,Fangchen Yu,Yafu Li,Peng Ye,Ning Ding,Yu Cheng*
...
### [52] [Inducing Reward-Free Judging Rubrics that Reduce Over-Crediting in Agent Evaluation](https://arxiv.org/abs/2608.13564)
...
### [53] [Depth-Aware Sensitivity Analysis of Mixture-of-Experts Models via Magnitude-Based Expert Masking](https://arxiv.org/abs/2608.13565)
...
### [54] [Modular Cognitive Architecture Emerges in Large Language Models](https://arxiv.org/abs/2608.13567)
...
### [55] [A Year in LLM Serving: Workload Evolution, Caching and Load-Balancing](https://arxiv.org/abs/2608.13573)
...
### [56] [Agentao: A Governed Local-First Runtime for Tool-Using LLM Agents](https://arxiv.org/abs/2608.13574)
...
### [57] [AI Evaluation Should Work With Humans](https://arxiv.org/abs/2608.13577)
...
### [58] [Stable Miscalibration in Large Language Models: A Practical View of High-Confidence Errors](https://arxiv.org/abs/2608.13591)
*Akira Okutomi*
...
### [89] [Implementing Computational Law in Wolfram Language for the Governance of Artificial Intelligence](https://arxiv.org/abs/2608.13958)
*James K. Wiles*
...
### [90] [Stable Miscalibration in Large Language Models: A Practical View of High-Confidence Errors](https://arxiv.org/abs/2608.13591)
*Akira Okutomi*
...
### [92] [Cross-Disciplinary Taxonomy and Modeling of Misunderstanding Generation, Amplification, and Detection, from Pragmatics to AI Agents](https://arxiv.org/abs/2608.13604)
*Babak Abbaschian*
...
### [93] [Content Depth Matters in Short-Video Recommendation: Rethinking the Attention Economy](https://arxiv.org/abs/2608.13990)
...
### [94] [MobileMem: Learning from a Year of Mobile Experiences](https://arxiv.org/abs/2608.13606)
*Xinle Deng,Yida Xue,Xiangyuan Ru,Haoming Xu,Shuofei Qiao,Mengru Wang,Yijun Chen,Buqiang Xu,Chen Jiang,Yuchen Eleanor Jiang,Lizhong Wang,Jianfeng Wang,Li Zeng,Haofen Wang,Guilin Qi,Huajun Chen,Ningyu Zhang*
...
### [95] [Simulation-Driven Vehicular Traffic Data Augmentation: Extending Sensor Coverage Through Virtual Sensing](https://arxiv.org/abs/2608.13993)
...
### [96] [No Universal Signal Predicts Sample-Level LLM Regression under Version Updates](https://arxiv.org/abs/2608.13607)
*Jia Sheng,Yiwei Lu*
...
### [97] [Buy the Rumor, Sell the News: When Is News Priced In?](https://arxiv.org/abs/2608.14014)
...
### [98] [ARC: Fair Relative Advantage Comparison in Open-Ended Real-World Interaction](https://arxiv.org/abs/2608.13622)
*Yongqi Tong,Tan Li Hui Faith,Choy Zhen Wen Marcus,Zhou Jin,Kewei Fu,Jiang-Ming Yang,Jianshe Li,Xin Zhang*
...
### [99] [Residual Dominance as a Structural Account of Last-Item Reliance in Causal Self-Attention Recommenders](https://arxiv.org/abs/2608.14021)
...
### [100] [A Calibrated Test of Internal Action Maps: State Signals Without Global Affine Closure](https://arxiv.org/abs/2608.13626)
*Dekun Yang*
...
### [101] [Agent-Orchestration in Autonomous Chip Design](https://arxiv.org/abs/2608.14035)
*Linyang Li*
...
### [102] [Demystifying Agent Skills: Why They Work-Until They Don't](https://arxiv.org/abs/2608.14036)
...
### [104] [Benchmarking data-driven material models on the classic Treloar dataset](https://arxiv.org/abs/2608.14063)
...
### [105] [Scaling Domain Data Repetition in LLM Pretraining](https://arxiv.org/abs/2608.14071)
...
### [106] [Mandato: Protocol-Level Enforcement of Digitally Signed Mandates on AI Agent Actions with Cryptographically Chained Audit Trails](https://arxiv.org/abs/2608.14074)
*Giovanni Racioppi*
...
### [107] [Never the Number: Structural Abstention for AI Systems Whose Answers Are Consumed as Fact](https://arxiv.org/abs/2608.13926)
*Zhelun,Wu*
...
### [108] [A Pathway to General-Purpose Scientific AI: Multimodal Comprehension of Scientific Images](https://arxiv.org/abs/2608.14075)
...
### [109] [Regime-Conditional Verification: Correctness Estimation for Adapting and Monitoring Safety Classifiers](https://arxiv.org/abs/2608.14089)
...
### [110] [Regime-Conditional Verification: Correctness Estimation for Adapting and Monitoring Safety Classifiers](https://arxiv.org/abs/2608.14089)
*Thiago Sandoval,Ufuk Topcu*
...
### [112] [A Graph-Based Reinforcement Learning Framework for Structured Drift Diagnosis and Recovery in Autonomous LLM Agents](https://arxiv.org/abs/2608.14109)
...
### [113] [Reinforcement Learning-Based Production Scheduling in an Industry-Based Coating Scenario Using the Digital Model Playground](https://arxiv.org/abs/2608.14122)
...
### [114] [MathForm: Scaling Mathematical Autoformalization with Knowledge Retrieval and Verification-Guided Refinement](https://arxiv.org/abs/2608.14221)
...
### [116] [Grounding Without Corrective Control: Truth-Tracking Profiles for Large Language Models](https://arxiv.org/abs/2608.14252)
*Brett Reynolds*
...
### [117] [QuaSAR: Quantization Compensation via Stable Activation-Aware Rank Truncation](https://arxiv.org/abs/2608.14149)
...
### [118] [AnchorBench: A Multi-Pathway Benchmark for the Anchoring Effect in LLMs](https://arxiv.org/abs/2608.14320)
...
### [119] [Towards Efficient Multimodal and Multilingual Opinion Extraction for STI: A QLoRA-Based Fine-Tuning Approach](https://arxiv.org/abs/2608.14152)
...
### [121] [Removing Temporal Note Redundancy Improves Multimodal Reinforcement Learning for Medicine](https://arxiv.org/abs/2608.14157)
...
### [124] [Split the Labor: Separating Evidence Interpretation from Decision Aggregation](https://arxiv.org/abs/2608.14509)
*Zhelun Wu*
...
### [142] [Modular Cognitive Architecture Emerges in Large Language Models](https://arxiv.org/abs/2608.13567)
*Pengrui Han,Jacob Andreas,Evelina Fedorenko,Andrea Gregor de Varda*
...
### [143] [Wrong but Useful: Trajectory Value Beyond Answer Correctness in Multi-Agent Messages](https://arxiv.org/abs/2608.14375)
*Chih-Hsuan Yang,Anjir Ahmed Chowdhury,Cheng-Hau Yang,Weijian Zheng,Fernando Llorente,Xiaolong Ma,Xinyang Li,Eliu A. Huerta,Ian T. Foster,Rajeev Thakur*
...
### [144] [AgentRewind: Recoverable Execution for Long-Horizon LLM Agents](https://arxiv.org/abs/2608.14380)
...
### [145] [AI Evaluation Should Work With Humans](https://arxiv.org/abs/2608.13577)
*Jan Kulveit,Gavin Leech,Tomáš Gavenčiak,Raymond Douglas*
...
### [147] [LLMs Don't Pay for the Jump](https://arxiv.org/abs/2608.14397)
*Paras Balani,Subhrakanta Panda*
...
### [151] [Knowing When to Stop: Bayesian Optimal Stopping for LLM Evaluations](https://arxiv.org/abs/2608.14425)
*Toby D. Pilditch*
...
### [153] [The Dynamics of Intelligence Explosions](https://arxiv.org/abs/2608.14426)
*Toby Ord*
...
### [154] [Reward Machines for Signal Temporal Logic](https://arxiv.org/abs/2608.13625)
*Alper Kamil Bozkurt,Shangtong Zhang,Yuichi Motai*
...
### [155] [PACE-Bench: Benchmarking Physics Adaptation via Code Evolution in Dynamic Environments](https://arxiv.org/abs/2608.14441)
...
### [156] [A Calibrated Test of Internal Action Maps: State Signals Without Global Affine Closure](https://arxiv.org/abs/2608.13626)
*Dekun Yang*
...
### [161] [From Passive Delegates to Strategic Negotiators: Reinforcing Social Reasoning in Small Language Models with SocialRL](https://arxiv.org/abs/2608.13787)
*Wenyue Hua,Zachary Huang,Tyler Payne,Safoora Yousefi,Saleema Amershi,Asli Celikyilmaz*
...
### [164] [Participatory Moral AI Is Not Neutral: The Invisible Hand of Developers](https://arxiv.org/abs/2608.14522)
...
### [168] [A Graph-Based Reinforcement Learning Framework for Structured Drift Diagnosis and Recovery in Autonomous LLM Agents](https://arxiv.org/abs/2608.14109)
*Ismail El Hamraoui,Sagar Jose,Nicolas Bureau,Robert Plana*
...
### [172] [Clearing the Fog: Towards Installing and Refining Proactive Exploration Capabilities in LLM Agents](https://arxiv.org/abs/2608.14339)
*Zhizhao Guan,Chen Huang,Ziming Liu,Hongru Liang,Wenqiang Lei,See-Kiong Ng,Tat-Seng Chua,Anthony G Cohn*
...
### [175] [L-FNO: Lorentzian Fourier Neural Operator for Stochastic Event Dynamics](https://arxiv.org/abs/2608.13562)
...
### [176] [Don't Claim Benchmark-Oriented Optimization Improves General Coding Capability -- Diverse Evaluation Is Required](https://arxiv.org/abs/2608.13566)
...
### [177] [Robust XGBoosting for Regression](https://arxiv.org/abs/2608.13590)
...
### [178] [Training-Free Knowledge Transfer Across Model Scales through Activation-Guided Pruning](https://arxiv.org/abs/2608.13596)
...
### [179] [Hard Cases, Bad Labels: Testing Error Exposure and Error Location in Uncertainty Sampling Under Bounded Label Noise](https://arxiv.org/abs/2608.13601)
*John Myron Uy*
...
### [180] [Robust Dual-Model Collaborative Random Vector Functional Link Network](https://arxiv.org/abs/2608.13628)
...
### [181] [Contrastive Learning for Interpretable Anomaly Detection at Collider Experiments](https://arxiv.org/abs/2608.13652)
...
### [182] [The Query Knows What to Forget: A Second Erase Direction for Linear Attention](https://arxiv.org/abs/2608.13668)
...
### [184] [EEG-PRISM: Physiologically-Grounded Interpretability of Predictions by EEG Foundation Models](https://arxiv.org/abs/2608.13676)
...
### [185] [SAGE: Surrogate-gradient Adaptation via Attention-Guided Entropy for Spiking Transformers](https://arxiv.org/abs/2608.13702)
...
### [186] [Capacity-Dependent Effects of Data Selection for Reasoning](https://arxiv.org/abs/2608.13721)
...
### [187] [The Integer Alibi: Localizing Cross-Kernel Divergence in INT8-Quantized LLM Inference](https://arxiv.org/abs/2608.13756)
*Teng-Ruei Chen*
...
### [188] [CutClean: Neural Network Pruning for Privacy-Preserving Inference](https://arxiv.org/abs/2608.13773)
...
### [189] [PPAPlace: Differentiable Cross-Stage Objectives for Chip Placement Optimization](https://arxiv.org/abs/2608.13790)
*Ruogu Chen,Jie Han*
...
### [190] [Recent Advances in Deep Learning-Based Drug-Target Binding Affinity Prediction](https://arxiv.org/abs/2608.13797)
...
### [191] [Dynamic Multi-Depot Vehicle Routing with Online Requests: Event-Driven Transformer--DRL and Rolling-Horizon Benchmarking](https://arxiv.org/abs/2608.13799)
...
### [192] [Stochastic Control Policies for Robust Molecular Transition Path Sampling](https://arxiv.org/abs/2608.13800)
...
### [193] [HI-MeshGraphNets: Efficient and Accurate Mesh-based Physics Learning with Hierarchical Multi-scale Graph Neural Networks](https://arxiv.org/abs/2608.13827)
...
### [194] [Federated Prompt Learning: A Unified Framework, Empirical Analysis, and Future Directions](https://arxiv.org/abs/2608.13844)
...
### [195] [Geometric Filtering of LLM-Generated Samples for Few-Shot Text Classification](https://arxiv.org/abs/2608.13866)
...
### [196] [Variation Brownian Kernel Ladders](https://arxiv.org/abs/2608.13882)
...
### [197] [Fashion Outfit Generation via Unified Sequential Composition Models](https://arxiv.org/abs/2608.13888)
...
### [198] [MedMix: Specialization-Consistent Federated Sparse MoEs under Modality Heterogeneity](https://arxiv.org/abs/2608.13911)
...
### [199] [Hybrid Quantum-inspired Kolmogorov-Arnold Networks for Privacy-Aware Federated Biosignal Learning](https://arxiv.org/abs/2608.13914)
...
### [200] [High-dimensional nonparametric changepoint detection via low-rank degree-two density projection](https://arxiv.org/abs/2608.13922)
...
### [201] [CForce: Boosting Parallel Decoding for dLLMs via Consistency Forcing](https://arxiv.org/abs/2608.13925)
...
### [203] [Probabilistic indirect models for undrained shear strength: addressing significant data missing and variability with advanced imputation and machine learning techniques](https://arxiv.org/abs/2608.13934)
...
### [204] [Polar Code Based Federated Learning: Convergence Analysis and Resource Allocation](https://arxiv.org/abs/2608.13961)
...
### [206] [Identifiability and Order-Dimension Limits of In-Context Learning on Partial Orders](https://arxiv.org/abs/2608.14004)
...
### [208] [Adversarial Learning of Classifier-Free Guidance Schedules](https://arxiv.org/abs/2608.14038)
...
### [209] [Model-agnostic Retrieval-Augmented Extended Forecasting for time series](https://arxiv.org/abs/2608.14054)
...
### [210] [When Denoising Hurts: Rethinking the Terminal Step of Diffusion Time Series Forecasters -- Extended Version](https://arxiv.org/abs/2608.14067)
...
### [211] [Resource-Adaptive Primal-Dual Learning for One-Warehouse Multi-Store Systems with Censored Demand](https://arxiv.org/abs/2608.14096)
*Jiameng Lyu*
...
### [212] [Sequence prediction under a lying oracle](https://arxiv.org/abs/2608.14102)
...
### [213] [Forecast Collapse in Time-Series Foundation Models](https://arxiv.org/abs/2608.14106)
...
### [219] [CForce: Boosting Parallel Decoding for dLLMs via Consistency Forcing](https://arxiv.org/abs/2608.13925)
*Yuji Ren,Chenkai Xu,Zhuocheng Gong,Jianguo Li,Zhijie Deng*
...
### [220] [Smart routes: a system for development and comparison of algorithms for solving vehicle routing problems with realistic constraints](https://arxiv.org/abs/2608.14140)
...
### [221] [Deep Reinforcement Learning solution for pickup and delivery routing problems with time window and capacity constraints](https://arxiv.org/abs/2608.14156)
...
### [223] [Structure-Guided Spatiotemporal Attention Graph Neural Network for Traffic Flow Prediction](https://arxiv.org/abs/2608.14177)
...
### [224] [Revisiting Energy-based Tabular Anomaly Detection: Energy and Reconstruction are Complementary](https://arxiv.org/abs/2608.14186)
*Junichiro Niimi*
...
### [225] [KV Cache Compression Through the Lens of Transform Coding](https://arxiv.org/abs/2608.14191)
...
### [226] [KV Cache Compression Through the Lens of Transform Coding](https://arxiv.org/abs/2608.14191)
*Hannah Laus,Claudio Mayrink Verdun,Hao Wang,Flavio du Pin Calmon,Felix Krahmer*
...
### [227] [MINT: A Universal Zero-Shot Predictor for Transaction Data](https://arxiv.org/abs/2608.14198)
...
### [228] [MINT: A Universal Zero-Shot Predictor for Transaction Data](https://arxiv.org/abs/2608.14198)
*Parameswaran Kamalaruban,Viktor Drobnyi,Maeve Madigan,Julia Rozanova,David Sutton,Stuart Burrell*
...
### [229] [Adaptive Protection for Evolutionary Feature Construction in Symbolic Regression with Application to Credit Classification](https://arxiv.org/abs/2608.14209)
...
### [230] [Training Fair Tabular Foundation Models](https://arxiv.org/abs/2608.14211)
...
### [231] [Connected Subspace Clustering: Hardness, a Scalable Heuristic, and an Application to Sea Level Geodesy](https://arxiv.org/abs/2608.14215)
...
### [232] [AutoSchema: Live Schema Grounding for Agentic Text-to-Sparql over Heterogeneous Knowledge Graphs](https://arxiv.org/abs/2608.14228)
...
### [233] [Multi-Objective Bayesian Optimization for Model Merging](https://arxiv.org/abs/2608.14264)
...
### [234] [Convex losses and their applications to SVM, SVR, and Shallow Neural Networks](https://arxiv.org/abs/2608.14288)
*Filippo Portera*
...
### [235] [Detecting Contaminated Code-Generation Prompt Batches via Influence Functions](https://arxiv.org/abs/2608.14303)
...
### [236] [Quantum Multi-Armed Bandits and Linear Bandits: Lower Bounds and Algorithms](https://arxiv.org/abs/2608.14319)
...
### [237] [Non-Parametric Spatiotemporal Trajectory Prediction via State-Conditioned Transition Sampling](https://arxiv.org/abs/2608.14349)
...
### [238] [Mind the Long Tail: Understanding the Difficulty of Delay Detection in Business Processes](https://arxiv.org/abs/2608.14367)
...
### [239] [Catching the Imposter: Self-Supervised Learning of Physical Coherence with Cross-Entity Feature Permutations](https://arxiv.org/abs/2608.14372)
...
### [240] [Boosting Data Augmentation with Stochastic Weight Averaging](https://arxiv.org/abs/2608.14373)
...
### [241] [DeaMoE: Efficient MoE Structure for Fast Small-Batch Decoding](https://arxiv.org/abs/2608.14385)
...
### [242] [CytoBERT: A Foundation Model for Cytometry Data](https://arxiv.org/abs/2608.14414)
...
### [243] [More Correct Mass, Worse Answers: Why Power Sampling Can Fail and How to Fix It](https://arxiv.org/abs/2608.14420)
...
### [244] [Designing Reinforcement Learning for Diffusion Models: A Unified Path-Space View](https://arxiv.org/abs/2608.14430)
...
### [245] [Designing Compact Neural Architectures via Neuron Gating and Mixed Activation](https://arxiv.org/abs/2608.14443)
...
### [246] [LP-NAS: Linear Programming-based Neural Architecture Search](https://arxiv.org/abs/2608.14472)
*Abhishek Shukla,Ankur Sinha,Faiz Hamid*
...
### [247] [Approximate Muon with low-rank adapters](https://arxiv.org/abs/2608.14492)
...
### [248] [Generating Benchmark Health Data Using a Tabular Diffusion Transformer](https://arxiv.org/abs/2608.14496)
...
### [249] [Rollplex: Cross-Phase GPU Spatial Sharing for Vision Language Model Post-Training](https://arxiv.org/abs/2608.14498)
...
### [250] [RecipeNet: A Hierarchical Transformer for Recipe Data](https://arxiv.org/abs/2608.14505)
...
### [251] [Don't Claim Benchmark-Oriented Optimization Improves General Coding Capability -- Diverse Evaluation Is Required](https://arxiv.org/abs/2608.13566)
*Egor Shibaev,Vera Kudrevskaia,Timur Galimzyanov,Mikhail Evtikhiev,Ana Terna,Rastislav Rabatin,Timur Kudashev,Timofey Bryksin,Arina Puchkova,Patrik Bartak,Egor Bogomolov,Sergey Titov*
...
### [252] [Training-Free Knowledge Transfer Across Model Scales through Activation-Guided Pruning](https://arxiv.org/abs/2608.13596)
*Jiahe Fan,Si Chen,Yinghao Hou,Aiyuan Zhang,Hong Xie*
...
### [253] [From BERT to Frontier Agents: Eight Years of Language-Model Progress, the Collapse of the Capability-Cost Curve, and the Rise of Task-Targeted Models](https://arxiv.org/abs/2608.13675)
*Pranav Kumar Kaliaperumal*
...
### [254] [SAGE: Surrogate-gradient Adaptation via Attention-Guided Entropy for Spiking Transformers](https://arxiv.org/abs/2608.13702)
*Kiran Nair,Rodrigue Rizk,KC Santosh*
...
### [255] [Capacity-Dependent Effects of Data Selection for Reasoning](https://arxiv.org/abs/2608.13721)
*Cuong Dang,Hoang Anh Just,Ruoxi Jia*
...
### [256] [CutClean: Neural Network Pruning for Privacy-Preserving Inference](https://arxiv.org/abs/2608.13773)
*Leonardo Magliolo,Vito Paolo Pastore,Giuseppe Valenzise,Enzo Tartaglione*
...
### [257] [PPAPlace: Differentiable Cross-Stage Objectives for Chip Placement Optimization](https://arxiv.org/abs/2608.13790)
*Ruogu Chen,Jie Han*
...
### [258] [Federated Prompt Learning: A Unified Framework, Empirical Analysis, and Future Directions](https://arxiv.org/abs/2608.13844)
*Qinglin Yang,Chen Qiu,Hongyuan Zhang,Pengdeng Li,Yuan Liu,Zhihong Tian*
...
### [259] [Hybrid Quantum-inspired Kolmogorov-Arnold Networks for Privacy-Aware Federated Biosignal Learning](https://arxiv.org/abs/2608.13914)
*Chun-Hua Lin,Samuel Yen-Chi Chen,Yu-Chao Hsu,Kuo-Chung Peng,Jiun-Cheng Jiang,Chi-Sheng Chen,Tai-Yue Li,Nan-Yow Chen,En-Jui Kuo,Hsi-Sheng Goan*
...
### [260] [CForce: Boosting Parallel Decoding for dLLMs via Consistency Forcing](https://arxiv.org/abs/2608.13925)
*Yuji Ren,Chenkai Xu,Zhuocheng Gong,Jianguo Li,Zhijie Deng*
...
### [261] [Forecast Collapse in Time-Series Foundation Models](https://arxiv.org/abs/2608.14106)
*Shu Wan,Miles Ma,Hank Zhu,Guangqi Liu,Stephen Wang,Qingsong Wen,Huan Liu*
...
### [262] [From Fixed Grids to Moving Particles:A Transferable Latent Operator for Fluid Dynamics](https://arxiv.org/abs/2608.14120)
*Meng Li,Chuqi Chen,Zhengqing Gao,Xi Zhou,Xiao Sun,Yang Xiang,Huaxi Huang*
...
### [263] [Overcoming Shortcut Learning in Graph Neural Networks through Active Explanation Guidance](https://arxiv.org/abs/2608.14121)
*Taraneh Younesian,Steve Azzolin,Antonio Longa,Francesco Ferrini,Vincenzo Marco De Luca,Stefano Teso*
...
### [264] [Structure-Guided Spatiotemporal Attention Graph Neural Network for Traffic Flow Prediction](https://arxiv.org/abs/2608.14177)
*Xuanmian He,Can Li,Wanjing Ma*
...
### [265] [Training Fair Tabular Foundation Models](https://arxiv.org/abs/2608.14211)
*Patrik Kenfack,Jesse C. Cresswell,Anthony L. Caterini,Samira Ebrahimi Kahou,Ulrich Aïvodji*
...
### [266] [Multi-Objective Bayesian Optimization for Model Merging](https://arxiv.org/abs/2608.14264)
*Utkarsh Agarwal,Vamshi Bonagiri,Raul Astudillo,Monojit Choudhury*
...
### [267] [Mind the Long Tail: Understanding the Difficulty of Delay Detection in Business Processes](https://arxiv.org/abs/2608.14367)
*Keyvan Amiri Elyasi,Lukas Kirchdorfer,Heiner Stuckenschmidt*
...
### [269] [Designing Compact Neural Architectures via Neuron Gating and Mixed Activation](https://arxiv.org/abs/2608.14443)
*Abhishek Shukla,Ankur Sinha,Faiz Hamid*
...
### [270] [LP-NAS: Linear Programming-based Neural Architecture Search](https://arxiv.org/abs/2608.14472)
*Abhishek Shukla,Ankur Sinha,Faiz Hamid*
